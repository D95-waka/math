...
\begin{proof}
	$f$ is primitive-recursive and therefore $\Sigma_1^0$, or without loss of generality $\Sigma_1$, meaning that there is $\psi(x_0, \ldots, x_{k - 1}, y)$ such that $\psi(\bar{x}, y) \iff f(\bar{x}) = y$.
\end{proof}
