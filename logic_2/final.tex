...
\begin{proof}
	...
	Let $\Mm_0$ be a $\Gamma$-homogeneous structure with $M = [r]$.
	% We will extend $\Mm$ to $\Nn_0$ such that $N_0 = \NN$, it suffices to define the relations $R_i$,
	% \[
	% 	R_i^{\Nn_0}(\langle a_i \mid i < k_i \rangle)
	% 	\iff R_i^{\Mm_0}(\langle \min\{ r - 1, a_i \} \mid i < k_i \rangle)
	% .\]
	Let us define,
	\[
		\varphi_i
