...
נרצה למצוא דרך לתאר טופולוגיה על־ידי בסיס, בדומה למרחבים וקטוריים.
...
\begin{proof}
	...
	\]
\end{proof}
\begin{corollary}[משפט נקודת השבת של בראואר]
...
\subsection{משפט ואן־קמפן הכללי}
