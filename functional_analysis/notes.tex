...
\begin{proof}
	...
	נתחיל בהגדרה של $\Delta_0 = A$ ולכן יש אינסוף נקודות של הסדרה, וכן נבחין כי $|A_0| = 2R$.
...
\begin{definition}[מרחב נורמי]
	...
	\begin{enumerate}
		...
		\item $\forall x, y \in V, \lVert x + y \rVert = \lVert x \rVert + \lVert y \rVert$
	\end{enumerate}
...
\begin{proof}
	...
	\]
	עובדה ידועה היא $At^2 + Bt + C \ge 0 \implies V^2 - 4AC \le 0$ ולכן,
	\[
