...
\begin{proof}
	...
	ולכן נקבל,
	\[
		F_x \cos \varphi + F_y \cos \varphi
		= F_r \cos^2 \varphi + F_r \sin^2 \varphi
		= F_r 
	\]
	אבל גם $r \cos \varphi = x \iff \frac{x}{r} = \cos \varphi$ וכך גם $\frac{y}{r} F_y = \sin \varphi$ וקיבלנו את השוויון הראשון.
...
\[
	...
	= \frac{x}{r} \partial_x + \frac{y}{r} \partial_y,
	\qquad
	\partial_y
...
\begin{proof}
	\[
		...
		= \frac{d}{dr} F_r(r, \varphi)
		= \cos \varphi F_x + \sin \varphi F_y
	\]
	כאשר השתמשנו בהגדרת האופרטור, הגדרת ההטלות ולבסוף בסעיף א'.
	אותו תהליך בדיוק מניב את כלל השוויונות.
\end{proof}
...
\]
\begin{proof}
	הגדרנו את הדיברגנץ עבור שדות וקטוריים $\RR^2 \to \RR^2$ על־ידי,
	\[
		\Div F
	...
	\begin{align*}
		\frac{1}{r} \partial_r(r F_r)
		& = \frac{1}{r} (\frac{x}{r} \partial_x (r F_r) + \frac{y}{r} \partial_y (r F_r)) \\
		& = \frac{1}{r^2} (x \partial_x (x F_x + y F_y) + y \partial_y (x F_x + y F_y)) \\
		& = \frac{1}{r^2} (x (1 \cdot F_x + x \partial_x F_x + y \partial_x F_y) + y (x \partial_y F_x + F_y + y \partial_y F_y)) \\
		& = \frac{1}{r^2} (x F_x + y F_y + x^2 \partial_x F_x + y^2 \partial_y F_y + xy (\partial_x F_y + \partial_y F_x))
	\end{align*}
	וכן,
	\begin{align*}
		\frac{1}{r} \partial_\varphi F_\varphi
		& = \frac{1}{r} (-y \partial_x F_\varphi + x \partial_y F_\varphi) \\
		& = \frac{1}{r} (-y \partial_x (- \frac{y}{r} F_x + \frac{x}{r} F_y) + x \partial_y (- \frac{y}{r} F_x + \frac{x}{r} F_y)) \\
		& = \frac{1}{r^2} (-y \partial_x (- y F_x + x F_y) + \frac{x y}{r^2} \partial_x(\cdots) + x \partial_y (- y F_x + x F_y) - \frac{x y}{r^2}(\cdots)) \\
		& = \frac{1}{r^2} (-y \partial_x (- y F_x + x F_y) + x \partial_y (- y F_x + x F_y)) \\
		& = \frac{1}{r^2} (-y (-y \partial_x F_x + F_y + x \partial_x F_y) + x (- F_x - y \partial_y F_x + x \partial_y F_y) ) \\
		& = \frac{1}{r^2} (-y F_y - x F_x + y^2 \partial_x F_x + x^2 \partial_y F_y - x y (\partial_x F_y + \partial_y F_x))
	\end{align*}
	ולכן מתקבל,
	\[
		\frac{1}{r} \partial_r(r F_r) + \frac{1}{r} \partial_\varphi(F_\varphi)
		= \frac{2}{r^2} (y^2 \partial_x F_x + x^2 \partial_y F_y)
	\]
