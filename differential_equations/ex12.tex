...
\begin{proof}
	...
	\[
		...
		= \sup\{ \lVert T g(x) \rVert \mid x \in \overline{\Omega} \}
		= \max\{ \lVert T g(x) \rVert \mid x \in \overline{\Omega} \}
	\]
	כאשר המעבר האחרון נובע מתחום קומפקטי.
	נבחין כי זוהי פונקציה הרמונית כפתרון של בעיית לפלס ולכן מקסימום זה מתקבל על השפה ובפרט סופי.
	קיבלנו אם כך שגם $\lVert T g \rVert_\infty = \lVert g \rVert_\infty$, מאותה הסיבה בדיוק.
	מהגדרת נורמה אופרטורית נקבל אם כך שגם $\lVert T \rVert_{\operatorname{op}} \le 1$.
\end{proof}
