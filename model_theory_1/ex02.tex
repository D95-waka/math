...
\begin{proof}
	...
	Notice that $T_{EQ}^*$ was proved to be complete in previous courses and thus model complete, it follows that indeed $T_{EQ}^*$ is the unique model companion of $T$.
\end{proof}
