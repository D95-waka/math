...
\begin{definition}[תורה טרנסצנדטלית לחלוטין]
	...
	\]
	עקבית, וכן $\varphi_{s \frown \{ 0 \}}(\bar{x}) \land \varphi_{s \frown \{ 1 \}}(\bar{x})$ לא עקבית.
\end{definition}
\begin{proposition}
...
\begin{proof}
	...
	\[
		\varphi_{s \frown \langle 0 \rangle} = \varphi \land \psi,
		\qquad
		\varphi_{s \frown \langle 1 \rangle} = \varphi \land (\lnot \psi)
	\]
