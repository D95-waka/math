...
\begin{theorem}[שוויון גיליים]
	נניח ש־$\Mm_1, \Mm_2$ מבנים בני־מניה כך ש־$\Age(\Mm_1) = \Age(\Mm_2)$ והומוגניים בחלש, אז $\Mm_1 \cong \Mm_2$. \\
...
\end{proof}
\begin{corollary}
	במקרה ש־$\Mm$ בן־מניה, אם $\Mm$ הומוגני בחלש אז הוא גם אולטרה־הומוגני (נבחר $\Mm_1 = \Mm_2 = \Mm$).
\end{corollary}
\begin{definition}[מחלקת פרייסה]
	$K$ נקראת מחלקת פרייסה אם מתקיימות התכונות:
	\begin{enumerate}
		\item כל איברי $K$ נוצרים סופית
		\item יש ב־$K$ מספר בן־מניה של טיפוסי איזומורפיזם
...
\end{definition}
\begin{proposition}
	אם $\Mm$ מבנה בן־מניה אולטרה־הומוגני אז $K = \Age(\Mm)$ הוא מחלקת פרייסה.
\end{proposition}
\begin{proof}
...
\begin{theorem}[משפט פרייסה]
	אם $K$ מחלקת פרייסה אז יש מודל $\Mm$ בן־מניה אולטרה־הומוגני כך ש־$K = \Age(\Mm)$ והוא יחיד עד־כדי איזומורפיזם.
\end{theorem}
\begin{proof}
	...
	בהינתן $\Mm_n$ ממנה את כל השיכונים ־$\Aa_l$ ל־$\Mm_n$ על־ידי סדרה $\langle f_{n, l, i} \mid i < \omega \rangle$, נבחין כי קבוצה זו אכן בת־מניה שכן $\Aa_l$ נוצר סופית ו־$\Mm_n$ בן־מניה.
	...
	כמניה של $\langle \Aa_l, \Bb_l \rangle$ עברנו גם על כל הזוגות מהצורה $\langle \langle \emptyset, \Bb \rangle$ כאשר $\Bb \in K$ עד כדי איזומורפיזם ולכן $\Age(\Mm) \supseteq K$.
...
\end{definition}
\begin{proposition}
	יהי $\Mm$ מודל בן־מניה מעל שפה בת־מניה כך שתתי־המבנים הנוצרים סופית שלו סופיים. \\
...
\begin{proof}
	...
	יתר־על־כן לכל $\bar{a} \in M^n$ מתאימה נוסחה חסרת כמתים $\psi_{\bar{a}}$ שקובעת את טיפוס האיזומורפיזם יחד עם מניה של היוצרים.
...
\begin{theorem}[הרחבות עם מימוש חסום של טיפוסים]
	...
	כך שלכל $A \subseteq N$ בת־מניה $\Nn$ מממש לכל היותר $\aleph_0$ טיפוסים מתוך $S_1(A)$.
\end{theorem}
\begin{proof}
	...
	\]
	לכן כמות האפשרויות למקטעים אלו היא בת־מניה.
	כעת עבור $A \subseteq N$ בת־מניה ו־$A \subseteq Sk(B) = \langle B \rangle$ עבור $Sk$ סגור סקולם ו־$B \subseteq \{ b_i \mid i < \kappa \}$ בת־מניה.
	אם $a \in N$ אז $a = t(b_{j_0}, \ldots, b_{j_{k - 1}})$ ולכן ניתן לחשב את $tp(a / A)$ מתוך $tp(b_{j_0}, \ldots, b_{j_{k - 1}} / B)$ גורר שמ־$S_1(A)$, $\Nn$ מממש מספר בן־מניה של טיפוסים.
\end{proof}
...
\end{example}
\begin{remark}
	תהי $T$ תורה בשפה בת־מניה שהיא $\kappa$־קטגורית ל־$\kappa$ לא בת־מניה. אז $T$ היא $\omega$־יציבה.
\end{remark}
\begin{proof}
	נניח ש־$\Mm$ בן־מניה וצריך להראות שכמות הטיפוסים ב־$S_1(M)$ בת־מניה.
	...
	$\Nn_1$ מממש לכל היותר אוסף בן־מניה של טיפוסים מ־$S_1(A)$.
...
\end{corollary}
\begin{example}
	יתכן ש־$T$ היא $\kappa$־יציבה לאיזושהי $\kappa$ לא בת־מניה ולא $\omega$־יציבה.
...
\end{proof}
\begin{corollary}
	לכל מונה $\kappa$ ותורה $T$ בשפה בת־מניה היא $\kappa$־קטגורית אם ורק אם כל מודל בעוצמה $\kappa$ של $T$ רווי.
\end{corollary}
\begin{proof}
...
\begin{proof}
	...
	יהי $\Mm'$ מודל אטומי מעל $M_a$. נניח כעת ש־$b \in M'$ שמממש את $\Sigma(x)$, עבור טיפוס חלקי בן־מניה.
	...
	נעבור לאיך הלמה שאם $T$ היא $\kappa$־קטגורית מעל שפה בת־מניה ל־$\kappa \ge \aleph_1$ גוררת שהיא $\aleph_1$־קטגורית.
	אם נניח אחרת יש מודל $\Mm \models T$ בעוצמה $\aleph_1$ לא רווי, לכן יש טיפוס $\Sigma$ בן־מניה מושמט.
...
נניח ש־$\Mm$ ראשוני בן־מניה ו־$|\varphi(M)| = \aleph_0$, $\Mm \hookrightarrow \Nn_1$ ואם $\varphi(N_1)$ התמונות, אז $\varphi(M)$ זוג ווטיאני.
...
\end{proof}
\begin{theorem}[ווט]
	נניח ש־$T$ תורה בשפה בת־מניה שיש לה זוג ווטיאני.
