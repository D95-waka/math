...
\begin{example}
	...
	נניח ש־$f : \mu \to \omega_1$ עבור $\mu < \omega_1$ וכן $\sup \rng f = \bigcup \{ f(\delta) \mid \delta < \mu \}$ כאשר $f(\delta)$ בן־מנייה.
	אבל מאקסיומת הבחירה איחוד בן־מנייה של קבוצות בנות־מנייה הוא גם בן־מנייה.
\end{example}
...
\begin{itemize}
	\item משפט Vaught: תהי $T$ תורה בת־מנייה שלמה, אז לא יתכן של־$T$ יש בדיוק שני מודלים לא איזומורפיים בני־מנייה עד כדי איזומורפיזם
	\item משפט מורלי (Morley): יהי $\kappa$ מונה לא בן־מנייה, $T$ תורה מעל שפה בת־מנייה, אז $T$ היא $\aleph_1$־קטגורית אם ורק אם $T$ היא $\kappa$־קטגורית
\end{itemize}
...
\begin{example}
	...
	נניח בשלילה ש־$\psi \notin \Sigma_\varphi$ ושהוא בן־מנייה.
...
\begin{theorem}[השמטת טיפוסים]
	תהי $T$ תורה שלמה ועקבית בשפה בת־מנייה ו־$p \in S_1(T)$ טיפוס לא מבודד אז יש מודל $\Mm \models T$ שמשמיט את $p$. \\
...
\begin{proof}
	...
	תהי $\langle \langle d_n, p_{k_n} \rangle \mid n < \omega \rangle$ מנייה של כל הזוגות של קבועים וטיפוס מהרשימה.
...
נניח ש־$L$ שפה בת־מנייה, נעשיר את $L$ על־ידי $\aleph_0$ קבועים חדשים ונסמן את השפה ב־$\tilde{L}$.
...
\begin{definition}[רוויה]
	...
	מבנה $\Mm$ בן־מנייה נקרא רווי אם הוא $\omega$־רווי.
\end{definition}
\begin{example}
...
\end{example}
\begin{theorem}[איזומורפיזם מודלים רוויים בני־מנייה]
	נניח ש־$\Mm, \Nn \models T$ מודלים בני־מנייה רווים ו־$T$ שלמה.
...
\end{proof}
\begin{corollary}
	אם יש לתורה שלמה $T$ מודל בן־מנייה רווי, אז הוא יחיד עד כדי איזומורפיזם.
\end{corollary}
\begin{theorem}[Ryll-Nardzewzki]
	תהי $T$ תורה שלמה בשפה בת־מנייה ללא מודלים סופיים, אז התנאים הבאים שקולים:
	\begin{enumerate}
		...
		\item כל מודל בן־מנייה של $T$ הוא רווי
	\end{enumerate}
\end{theorem}
\begin{proof}
	ראינו כי $2 \iff 3$.
	...
	$1 \implies 2$,
	נניח בשלילה שיש טיפוס $p$ לא מבודד, אז $p$ טיפוס ולכן עקבי קיים מודל של $T$ שמממש אותו, אבל ממשפט השמטת טיפוסים יש מודל של $T$ שמשמיט אותו, שניהם בני־מנייה.
	...
	$5 \implies 1$,
	נובע מהמשפט שכל שני מודלים בני־מנייה רוויים איזומורפיים.
\end{proof}
...
\end{definition}
\begin{proposition}
	תהי $T$ תורה שלמה ללא מודלים סופיים מעל שפה בת־מנייה.
	אז התנאים הבאים שקולים:
	\begin{enumerate}
		\item $T$ היא $\aleph_0$־קטגורית
		\item לכל $n < \omega$ יש מודל בן־מנייה $\Mm \models T$ בו כל $D \subseteq M^n$ שהיא אינווריאנטית תחת $\aut(\Mm)$ היא $A$־גדירה ל־$A \subseteq M$ סופית
		\item לכל $n < \omega$ יש מודל בן־מנייה $\Mm \models T$ בו כל קבוצה $D \subseteq M^n$ כך שהיא $\aut(\Mm)$־אינווריאנטית היא גם $0$־גדירה
	\end{enumerate}
\end{proposition}
\begin{proof}
	$1 \implies 3$,
	...
	זה בלתי־אפשרי שכן יש מספר בן־מנייה של הגדרות אפשריות. \\
...
\begin{theorem}[שני המודלים של ווט]\label{theorem-two-models-of-vaught}
	אם $T$ תורה שלמה בשפה בת־מנייה,
	אז לא יתכן של־$T$ יש בדיוק שני מודלים בני־מנייה עד־כדי איזומורפיזם.
\end{theorem}
\begin{proof}
	אם יש $n$ עבורו $S_n(T)$ לא בן־מנייה אז יש מספר לא בן־מנייה של מודלים שונים.
...
נניח שהשפה שלנו היא בת־מנייה בחלק זה.
\begin{definition}[תורה קטנה]
	תורה $T$ תיקרא קטנה אם לכל $n < \omega$ מתקיים $|S_n(T)| \le \omega$.
\end{definition}
\begin{remark}
	אם $T$ איננה קטנה אז יש ל־$T$ מספר לא בן־מנייה של מודלים בני־מנייה, כאשר $T$ שלמה עקבית ובעלת מודל אינסופי.
\end{remark}
\begin{proof}
	נניח ש־$\aleph_1 \le |S_n(T)|$. לכל $p \in S_n(T)$ נתאים מודל $\Mm_p$ בן־מנייה שמממש את $p$.
	...
	\]
	ולכן מספר מחלקות השקילות הוא לא בן־מנייה.
	בהינתן $p$ מדוע יש מודל של $T$ בן־מנייה המממש את $p$: נעשיר את השפה $L$ בסימן קבוע ונסתכל על $T \cup p(c)$ העקבית.
\end{proof}
\begin{proposition}
	נניח ש־$T$ קטנה שלמה ועקבית ללא מודלים סופיים, אז יש מודל רווי ובן־מנייה ל־$T$.
\end{proposition}
\begin{proof}
	יהי $\Mm_0 \models T$ בן־מנייה.
	...
	יהי $\Mm_1$ שמקיים תורה זו, אז $\Mm_0 \prec \Mm_1$ ונבחן את $\bigcup_{|A| < \aleph_0, A \subseteq \Mm_1} S_n(A)$, אוסף בן־מנייה.
	...
	נשים לב ש־$S_n(A)$ בן־מנייה עבור $A \subseteq M$ סופית ולכן $S_n(A) \hookrightarrow S_{n + |A|}(T)$ על־ידי התאמת טיפוסים מהצורה $p = \{ \varphi(a_0, \ldots, a_{k - 1}, x_0, \ldots, x_{n - 1}) \mid \varphi \in \form \}$,
...
\end{proof}
\begin{remark}
	למעשה $T$ קטנה אם ורק אם יש מודל רווי בן־מנייה.
\end{remark}
...
\begin{proof}
	...
	$\Mm_0 \prec \Nn \models T$ כש־$\Mm_0$ בן־מנייה אז $\Mm_0 \cong \Mm$ ומשרשור נקבל את $j$.
\end{proof}
\begin{proposition}
	אם $\Mm$ אטומי ובן־מנייה לתורה שלמה אז $\Mm$ ראשוני.
\end{proposition}
\begin{proof}
...
\begin{theorem}[שקילות לקיום מודל ראשוני]
	בשפה בת־מנייה, ל־$T$ שלמה יש מודל ראשוני אם ורק אם לכל $n$ אוסף הטיפוסים המבודדים צפוף ב־$S_n(T)$.
\end{theorem}
\begin{proof}
...
\section{שיעור 9 --- 14.12.2025}
נשאל את השאלה איך אפשר לתאר את $\QQ$ כגבול של סדרים קוויים סופיים.
ננסה לענות על שאלה זו בהרצאה הנוכחית.
\begin{definition}[גיל של מבנה]
	יהי $\Mm$ מבנה, $\Age(\Mm)$, הגיל של $\Mm$, הוא אוסף כל המבנים הנוצרים סופית ב־$L$ שאיזומורפיים לתת־מבנה של $\Mm$.
\end{definition}
\begin{remark}
	אם $\Aa \subseteq \Bb \in \Age(\Mm)$ אז גם $\Aa \in \Age(\Mm)$.
\end{remark}
\begin{definition}[מבנה אולטרה־הומוגני]
	מבנה $\Mm$ נקרא אולטרה־הומוגני אם לכל $\Aa, \Bb \subseteq \Mm$ נוצרים סופית ואיזומורפיזם $f : \Aa \to \Bb$ יש אוטומורפיזם $\sigma$ של $\Mm$ כך ש־$f \subseteq \sigma$.
\end{definition}
\begin{definition}[מבנה הומוגני בחלש]
	מבנה $\Mm$ נקרא הומוגני בחלש אם לכל $\Aa, \Bb \subseteq \Mm$ נוצרים סופית של $\Mm$ ושיכון $g : \Aa \to \Bb$ אז קיים שיכון $h$ מ־$\Bb$ ל־$\Mm$ כך ש־$h \circ g \restriction A = \id_A$.
\end{definition}
\begin{remark}
	אין משמעות להנחה ש־$\Bb$ תת־מבנה של $\Mm$ וזה שקול ל־$\Bb \in \Age(\Mm)$.
\end{remark}
\begin{proposition}
	יהי $\Mm$ מבנה לשפה $L$.
	אם $\Mm$ הוא אולטרה־הומוגני, אז $\Mm$ הוא הומוגני בחלש.
\end{proposition}
\begin{proof}
	נניח ש־$g : \Aa \to \Bb$ שיכון, ונניח ש־$f : \Bb \to \Mm$ שיכון אף הוא, אז $f \circ g : \Aa \to (f \circ g)(A)$ שיכון אף הוא.
	אלו שני תתי־מבנים נוצרים סופית ב־$\Mm$ ולכן יש $\sigma \in \aut(\Mm)$ כך ש־$\sigma \restriction A = f \circ g$.
	אז במקרה זה $\sigma^{-1} \circ f \circ g \restriction A = \id_A$.
\end{proof}
\begin{theorem}[שוויון גיליים]
	נניח ש־$\Mm_1, \Mm_2$ מבנים בני־מנייה כך ש־$\Age(\Mm_1) = \Age(\Mm_2)$ והומוגניים בחלש, אז $\Mm_1 \cong \Mm_2$. \\
	יתר־על־כן אם $f : \Aa \to \Bb$ שיכון, $\Aa \subseteq \Mm_1, \Bb \subseteq \Mm_2$ נוצרים סופית אז ניתן להרחיב את $f$ לאיזומורפיזם.
\end{theorem}
\begin{proof}
	נניח ש־$\Mm_1 = \bigcup_{n < \omega} \Aa_n$ איחוד של תתי־מבנים נוצרים סופית, ונניח ש־$\Mm_2 = \bigcup_{n < \omega} \Bb_n$ באופן דומה, בלי הגבלת הכלליות.
	נרצה להגדיר ברקורסיה פונקציות $f_n$ שמרחיבות זו את זו, נגדיר,
	\[
		f_0 = f,
		\qquad
		f_n : \Aa_{k_n} \to \Bb_{k_n'}
	\]
	עבור $k_n, k_n'$ עולים ממש. $f_n$ יהיה שיכון.
	נתון לנו שקיימת $g$ המרחיבה את $f_n$ לזהות $\Aa_{k_n} \to \Mm_1$.
	מהבנייה גם $g(\Bb_{k_{n' + 1}}) \subseteq \Aa_{k_{n + 1}}$.
	נקבל כך ש־$f_{n + 1} \restriction A_{k_n} = f_n$ וכן,
	\[
		\Bb_{k_{n + 1}'} \supseteq \im f_{n + 1} \supseteq \Bb_{k_{n + 1}'}
	\]
	ולכן $k_n' < k_{n + 1}'$ ובהתאם אם נסמן $f_{\omega} = \bigcup f_n$ וכן $\Mm_2 \subseteq \im f_{\omega}$.
	נסיק ש־$f_{\omega}$ איזומורפיזם כרצוי.
\end{proof}
\begin{corollary}
	במקרה ש־$\Mm$ בן־מנייה, אם $\Mm$ הומוגני בחלש אז הוא גם אולטרה־הומוגני (נבחר $\Mm_1 = \Mm_2 = \Mm$).
\end{corollary}
\begin{definition}[מחלקת פרייסה]
	$K$ נקראת מחלקת פרייסה אם מתקיימות התכונות:
	\begin{enumerate}
		\item כל איברי $K$ נוצרים סופית
		\item יש ב־$K$ מספר בן־מנייה של טיפוסי איזומורפיזם
		\item HP\@: אם $\Aa \subseteq \Bb \in K$ ו־$\Aa$ נוצר סופית אז $\Aa \in K$
		\item JEP (שיכון משותף): אם $\Aa, \Bb \in K$ אז יש $\Cc \in K$ כך ש־$f : \Aa \to \Cc, g : \Bb \to \Cc$ שיכונים
		\item AP (תכונת התצרופת): אם $\Aa, \Bb, \Cc \in K$ עם $g_A : \Cc \to \Aa, g_B: \Cc \to \Bb$ שיכונים, אז גם יש $f_A : \Aa \to \Dd \in K, f_B : \Bb \to \Dd$ כך שההרכבה מתחלפת, כלומר $f_A \circ g_A = f_B \circ g_B$
	\end{enumerate}
\end{definition}
\begin{proposition}
	אם $\Mm$ מבנה בן־מנייה אולטרה־הומוגני אז $K = \Age(\Mm)$ הוא מחלקת פרייסה.
\end{proposition}
\begin{proof}
	הכול טריוויאלי למעט AP\@ (ו־JEP שהוא מקרה פרטי של AP).

	יהיו $g_A : \Cc \to \Aa, g_B : \Cc \to \Bb$ ובלי הגבלת הכלליות נניח ש־$g_A = g_B = \id$, על־ידי מעבר לעותק איזומורפי של $\Aa, \Bb$.
	יהיו $f : \Aa \to \Mm, g : \Bb \to \Mm$ שיכונים נבחן את $f(\Cc) \cong g(\Cc)$ תתי־מבנים של $\Mm$ ולכן מאולטרה־הומוגניות של$\Mm$ יש $\sigma \supseteq g \circ f^{-1}$ אוטומורפיזם של $\Mm$.
	נגדיר את $\Dd = \langle \sigma \circ f(A), g(B) \rangle$, אז $\Dd$ תת־מבנה נוצר סופית של $\Mm$.
	אם $c \in C$ אז $g \circ \id(c) = \sigma \circ f \circ \id(c)$ שכן $\sigma \supseteq g \circ f^{-1} \restriction f(C)$.
\end{proof}
\begin{theorem}[משפט פרייסה]
	אם $K$ מחלקת פרייסה אז יש מודל $\Mm$ בן־מנייה אולטרה־הומוגני כך ש־$K = \Age(\Mm)$ והוא יחיד עד־כדי איזומורפיזם.
\end{theorem}
\begin{proof}
	נבנה סדרת מבנים עולה בהכלה $\langle \Mm_n \mid n < \omega \rangle$ כך ש־$\Mm_n \in K$.
	תהי $\langle \langle \Aa_l, \Bb_l \rangle \mid l < \omega \rangle$ סדרת כל הזוגות $\Aa, \Bb \in K$ כך ש־$\Aa \subseteq \Bb$ עד כדי איזומורפיזם.
	בהינתן $\Mm_n$ ממנה את כל השיכונים ־$\Aa_l$ ל־$\Mm_n$ על־ידי סדרה $\langle f_{n, l, i} \mid i < \omega \rangle$, נבחין כי קבוצה זו אכן בת־מנייה שכן $\Aa_l$ נוצר סופית ו־$\Mm_n$ בן־מנייה.
	נתחיל מ־$\Mm_0 \in K$ שרירותי.
	נניח כי קיים $\Mm_n$ ונבנה את $\Mm_{n + 1}$ בסדרת צעדים סופית כך שלכל $m, l, i < n$ אם $\Aa_l \xrightarrow{\id} \Bb_l \xrightarrow{g} \Mm_{n, k}$,
	כאשר $\Aa \xrightarrow{f_{m, l, i}} \Mm_m \subseteq \Mm_n \subseteq \Mm_{n, k}$.
	נבנה כך ש־$g \supseteq f_{m, l, i}$ ו־$\Mm_{n + 1} = \Mm_{n, k^*}$ עבור $k^*$ הצעד האחרון.
	נגדיר $\Mm = \bigcup_{n < \omega} \Mm_n$ ונטען ש־$\Mm$ אולטרה־הומוגני ו־$\Age(\Mm) = K$.
	כאשר $\Aa_l = \langle \emptyset \rangle$ קיבלנו ש־$\Bb_l$ משוכן לתוך $\Mm_n$ ולכן לתוך $\Mm$.
	כמנייה של $\langle \Aa_l, \Bb_l \rangle$ עברנו גם על כל הזוגות מהצורה $\langle \langle \emptyset, \Bb \rangle$ כאשר $\Bb \in K$ עד כדי איזומורפיזם ולכן $\Age(\Mm) \supseteq K$.
	מצד שני אם $\Bb \subseteq \Mm$ נוצר סופית אז $\Bb \subseteq \Mm_n$ נוצר סופית ל־$n < \omega$ מהתורשתיות של $K$ ולכן $\Bb \in K$. \\
	נניח כעת ש־$\Aa \subseteq \Mm$ נוצר סופית ו־$\Bb \in K$, $f : \Aa \to \Bb$ שיכון.
	אז $Aa_l = f(A) \subseteq \Bb = \Bb_l$ תת־מבנה נוצר סופית ולכן יש $l$ כך ש־$\Bb \in K$ ולכן בלי יש שיכון של $\Bb$ ל־$\Mm$ ובהתאם יש $\Bb \hookrightarrow \Mm_n$.
	הרכבת השיכונים הוא $f_{n, l, i}$ לאיזשהו $i$, $f_{n, l, i} : f(A_l) \to M_n$ ולכן יש $f_{n, l, i} \subseteq g$ כך ש־$g : \Bb \to \Mm_k \subseteq \Mm$.
	נקבל בהתאם ש־$\Aa \xrightarrow{f} \Bb \xrightarrow{g} \Mm$ כך ש־$\id : \Aa \to \Mm$ כנדרש, כאשר $g$ מרחיב את $f : f(A) \to \Mm$.
\end{proof}
\begin{definition}[מחלקת פרייסה סופית מקומית באופן אחיד]
	תהי $K$ מחלקת פרייסה.
	נאמר ש־$K$ סופית מקומית באופן אחיד אם לכל $n < \omega$ יש $f(n)$ טבעי כך שלכל $\Aa \in K$ הנוצר על־ידי $n$ איברים מתקיים $|A| < f(n)$.
\end{definition}
\begin{proposition}
	יהי $\Mm$ מודל בן־מנייה מעל שפה בת־מנייה כך שתתי־המבנים הנוצרים סופית שלו סופיים. \\
	אז אם $\Th(\Mm)$ היא $\omega$־קטגורית אז $\Age(\Mm)$ סופי מקומית באופן אחיד.
\end{proposition}
\begin{proof}
	יהי $n < \omega$ ונסתכל על $tp(a_0, \ldots, a_{n - 1})$ עבור $a_0, \ldots, a_{n - 1} \in M$.
	הטיפוס יכיל בין השאר שוויונות מהצורה $t_0(\bar{x}) = t_1(\bar{x})$ עבור $t_0, t_1$ שמות עצם ולקבל שמספר מחלקות השקילות הוא כגודל תת־המבנה $\langle \bar{a} \rangle$.
	אם $\Mm$ היא $\omega$־קטגורית אז $|S_n(\Th(\Mm))|$ סופית ולכן $f(n)$ יהיה מקסימום המגדלים על הטיפוסים.
\end{proof}
\begin{proposition}
	נניח ש־$\Mm$ מבנה כך ש־$\Age(\Mm)$ סופי מקומית באופן אחיד, $L$ סופית.
	אז לכל $n < \omega$ יש מספר סופי של טיפוסי איזומורפיזם לתת־מבנים הנוצרים על־ידי $n$ איברים.
\end{proposition}
\begin{proof}
	ברור, שכן גודל המבנה חסום ולכן יש מספר סופי של מימושים של סימני השפה.
\end{proof}
נעיר כי למעשה יש נוסחה חסרת כמתים $\psi_{\bar{a}}(\bar{x})$ שקובעת את טיפוס האיזומורפיזם של $\langle \bar{a} \rangle$.
\begin{remark}
	למעשה מ־$\omega$־קטגוריות נובע כי אין תת־מבנה שהוא נוצר סופית ואינסופי, אחרת היו אינסוף נוסחות מהצורה $t(\bar{x}) = y$ שאינן שקולות.
\end{remark}
\begin{lemma}
	יהי $\Mm$ מבנה אולטרה־הומוגני וסופי מקומית (השפה לא חייבת להיות סופית) כך שיש מספר סופי של טיפוסי איזומורפיזם של תת־מבנים נוצרים על־ידי $n$ איברים,
	אז $\Mm$ היא $\omega$־קטגורית ומחלצת כמתים.
\end{lemma}
\begin{proof}
	נוכיח קודם לשפה סופית.
	אם $\bar{a}, \bar{b}$ הן $n$־יות של איברים ב־$M$ ו־$\langle \bar{a} \rangle \cong \langle \bar{b} \rangle$,
	אז מאולטרה־הומוגניות $tp(\bar{a}) = tp(\bar{b})$ כי יש $\sigma : \Mm \to \Mm$ אוטומורפיזם $\sigma \supseteq f$ עבור $f(a_i) = b_i$.
	לכן ב־$\Mm$ מתממשים מספר סופי של טיפוסים. \\
	יתר־על־כן לכל $\bar{a} \in M^n$ מתאימה נוסחה חסרת כמתים $\psi_{\bar{a}}$ שקובעת את טיפוס האיזומורפיזם יחד עם מנייה של היוצרים.
	כלומר אם $\bar{b} \in M^n$ מקיים $\psi_{\bar{a}}(\bar{b})$ אז הפונקציה $f(a_i) = b_i$ מתרחבת לאיזומורפיזם $\langle \bar{a} \rangle \cong \langle \bar{b} \rangle$. \\
	נובע שיש מספר סופי של נוסחות שמגדירות את טיפוסי $\Mm$ מסדר $n$.
	לכן כל נוסחה ב־$n$ משתנים חופשיים ב־$\Mm$ שקולה לצירוף בולאני של אותן נוסחות. נשים לב כי נוסחות אלה הן חסרות כמתים ולכן יש חילוץ כמתים.
\end{proof}
\begin{remark}
	אם $L$ אינסופית זה עדיין עובד כי לכל $n$ תהיה תת־תורה סופית $L'$ כך שקיים $L$־איזומורפיזם בין $\langle \bar{a} \rangle$ ל־$\langle \bar{b} \rangle$ שקול לקיום $L'$־איזומורפיזם.
\end{remark}
\begin{remark}
	נניח ש־$\langle \bar{a} \rangle, \langle \bar{b} \rangle$ ונניח ש־$f(a_i) = b_i$ לא מתרחב לאיזומורפיזם.
	אז יש שמות עצם $s_0, \ldots, s_{k - 1}$ וסימן יחס $n$ שמעידים על כך,
	\[
		\lnot R(s_0(\bar{a}), \ldots, s_{k - 1}(\bar{a}))
		\leftrightarrow R(s_0(\bar{b}), \ldots, s_{k - 1}(\bar{b}))
	\]
\end{remark}
\begin{corollary}
	תהי $K$ מחלקת פרייסה כך שלכל $n$ טבעי יש מספר סופי של מחלקות איזומורפיזם בתוך $K$ של תת־מבנים הנוצרים על־ידי $n$ איברים, כך שהם כולם סופיים.
	אז גבול פרייסה הוא $\omega$־קטגורי ומחלץ כמתים.
\end{corollary}

\section{שיעור 10 --- 28.12.2025}
\subsection{רוויה ואוניברסליות}
\begin{definition}[קפא־רוויה]
	מודל $\Mm$ נקרא $\kappa$־רווי אם לכל $\Aa \subseteq \Mm$ עם $|A| < \kappa$ ולכל $p \in S_1(A)$, $p$ מתממש ב־$\Mm$. \\
	אם $|M| = \kappa$ נאמר גם ש־$\Mm$ רווי.
\end{definition}
\begin{definition}[רוויה ללא פרמטרים]
	$\Mm$ הוא רווי לטיפוסים בלי פרמטרים אם לכל $n < \omega$ ולכל $p \in S_n(\Th(\Mm))$, $p$ ממומש ב־$\Mm$. \\
	במקרה זה נסמן $< \aleph_0$־רווי.
\end{definition}
\begin{definition}[מודל אוניברסלי]
	מודל $\Mm$ הוא $\kappa$־אוניברסלי (כולל) אם לכל $\Nn$ כל ש־$\Nn \equiv \Mm$ ו־$|N| < \kappa$ יש שיכון אלמנטרי $f : \Nn \to \Mm$.
\end{definition}
\begin{definition}[קפא־הומוגניות]
	$\Mm$ הוא $\kappa$־הומוגני אם לכל $\Aa \subseteq \Mm, |A| < \kappa$ ושיכון אלמנטרי חלקי $f : A \to B$, לכל $a \in M$ יש $b \in M$ כך ש־$f \cup \{ \langle a, b \rangle \}$ שיכון אלמנטרי.
\end{definition}
\begin{remark}
	אם $|M| = \kappa$ אז ניתן יהיה להרחיב את $f$ לאוטומורפיזם של $\Mm$.
\end{remark}
\begin{theorem}[שקילות לתכונות של מודלים רוויים]
	התכונות הבאות שקולות עבור מודל $\Mm$ מעל שפה $L$ ומונה $\kappa$:
	\begin{enumerate}
		\item $\Mm$ הוא $\kappa$־רווי
		\item $\Mm$ הוא $\kappa$־הומוגני ומקיים לכל $\Nn \equiv \Mm$ ו־$\Aa \subseteq \Nn, |A| \le \kappa$ יש שיכון אלמנטרי חלקי $f : \Aa \to \Mm$
		\item $\Mm$ הוא $\kappa$־הומוגני ורווי לטיפוסים בלי פרמטרים
	\end{enumerate}
\end{theorem}
\begin{proof}
	$1 \implies 2$:
	נניח ש־$f : \Aa \to \im f$ שיכון אלמנטרי חלקי ו־$|A| < \kappa$, ותהי $a \in \Mm$.
	נסמן $p = tp(a / A) \in S_1(A)$ ו־$q = f_*(p) \in S_1(\im f)$, ולכן יש $b \in M$ שמממש את $q$ ואז $f \cup \{ \langle a, b \rangle \}$ שיכון חלקי. \\
	נניח את התכונה הראשונה וכן ש־$\Nn \equiv \Mm$ ו־$\Aa \subseteq \Nn, |A| \le \kappa$.
	נמנה את $A = \{ a_{\alpha} \mid \alpha < \alpha_* \}$ עבור $\alpha_* \le \kappa$.
	נבנה רקורסיבית את $f_{\alpha} : \{ a_{\beta} \mid \beta < \alpha \} \to \Mm$ שיכון אלמנטרי.
	נגדיר $f_0 = \emptyset$. נניח שבנינו את $f_{\beta}$ לכל $\beta < \alpha$, אם $\alpha$ גבולי אז נגדיר $f_{\alpha} = \bigcup_{\beta < \alpha} f_{\beta}$.
	אם $\alpha = \gamma + 1$ אז $p = tp(a / \{ a_{\beta} \mid \beta < \gamma \})$ ובהתאם $q = {(f_{\alpha})}_*(p)$ ממומש ב־$\Mm$.

	$2 \implies 3$:
	אם $p \in S_n(\Th(\Mm))$ אז יש $\Nn \equiv \Mm$ מממש את $p$.
	ניקח את $A = \{ a_0, \ldots, a_{n - 1} \}$ כך ש־$\bar{a}$ מממש את $p$.
	אם $f : \Aa \to \Mm$ שיכון אלמנטרי אז $\Mm \models p(f(a_0), \ldots, f(a_{n - 1}))$.

	$3 \implies 1$:
	נתונה לנו $\kappa$־הומוגניות ורוויה לטיפוסים ללא פרמטרים, ונראה $\kappa$־רוויה. \\
	באינדוקציה על מונים $\lambda < \kappa$ נוכיח שאם $|A| = \lambda$ ו־$p \in S_1(A)$ אז $p$ ממומש. \\
	עבור $n = \lambda < \aleph_0$ נניח ש־$A = \{a_0, \ldots, a_{\lambda - 1}\}$ ונניח,
	\[
		p = \{ \varphi(x, a_0, \ldots, a_{\lambda - 1}) \},
		\qquad
		q(x, a_0, \ldots, a_{n - 1})
	\]
	עבור $q \in S_{n + 1}(\Th(\Mm))$.

	כל יש $(b_0, \ldots, b_n)$ שמממשת את $q$ ב־$\Mm$.
	$tp(b_1, \ldots, b_n) = tp(a_0, \ldots, a_{n - 1})$ ולכן $f = \{ (a_i, b_{i + 1}) \mid i < n \}$ שיכון אלמנטרי ולכן ניתן להרחיבו על־ידי הוספת $b_0$ לתחומו ואותה ההרחבה תשלח את $b_n$ ל־$c$ עבור $\Mm \models p(c)$. \\
	נניח ש־$\aleph_0 \le \lambda$, מהנחת האינדוקציה $\Mm$ הוא $\lambda$־רווי ולכן טענה 2 מתקיימת עם $\lambda$.
	נניח כעת ש־$p \in S_1(A)$ ויהי $\Mm \prec \Nn$ שבה $p$ מתממש, כאשר $|A| = \lambda$.
	מתכונה 2 יש שיכון אלמנטרי חלקי $f : A \cup \{ b \} \to \Mm$ ואז נוכל להסתכל על $f(A) \subseteq M$ ונקבל ש־$f : A \to f(A)$ שיכון אלמנטרי חלקי.
	בהתאם $f(b)$ מממש את $f_*(p)$.
	מהומוגניות נרחיב את $f \restriction A$ על־ידי הוספת הערך $f(b)$ לתחום וכעת תמונת $f(b)$ תממש את $p$.
\end{proof}
\begin{corollary}
	אם יש $\kappa$ גדול בהרבה מ־$|T|$ עבורו $|\bigcup \{ 2^{\lambda} \mid \lambda < \kappa \}| = 2^{< \lambda} = \kappa$,
	אז יש מודל רווי מעוצמה $\kappa$ ל־$T$ יחיד עד כדי איזומורפיזם שהוא $\kappa$־אוניברסלי.
	למודל הזה נקרא $\Cc_T$ והוא נקרא מודל המפלצת של $T$.
\end{corollary}
\begin{theorem}[קיום מודל מפלצת]
	אם $2^{\lambda} = \lambda^+$ ואינסופי, $\Mm$ מודל אינסופי כך ש־$|M| \le \lambda^+$ כלשהו, אז יש מודל רווי $\Nn$ כך ש־$\Mm \prec \Nn$ ו־$|N| = \lambda^+$.
\end{theorem}
טענה זו הוכחה בתרגילי הבית.
\begin{corollary}
	אם $\Mm_1, \Mm_2$ מודלים רוויים ו־$\Mm_1 \equiv \Mm_2, |M_1| = |M_2|$ אז $\Mm_1 \cong \Mm_2$.
\end{corollary}
\begin{proof}
	נסמן $\kappa = |M_1| = |M_2|$ ובלי הגבלת הכלליות $\aleph_0 \le \kappa$.
	לכן שניהם $\kappa$־הומוגניים ונוכל לבנות ברקורסיה $\langle f_{\alpha} \mid \alpha < \kappa \rangle$ סדרה עולה של שיכונים אלמנטריים חלקיים.
	נוכל לוודא ש־$\bigcup_{\alpha < \kappa} f_{\alpha}$ איזומורפיזם.
	בהינתן $f_{\alpha}$ ו־$a \in M_1$, מ־$\kappa$־הומוגניות ניתן להרחיב את $f_{\alpha}$ ל־$f_{\alpha + 1}$ כך ש־$a \in \dom f_{\alpha + 1}$.
	באופן שקול אם $b \in M_2$ אז נרחיב את $f_{\alpha}^{-1}$ ל־$f_{\alpha + 1}^{-1}$ כך ש־$b \in \dom f_{\alpha + 1}^{-1}$.
\end{proof}
\begin{remark}
	קיבלנו שאם $\Mm$ רווי אז הוא הומוגני בחזק, כלומר כל $f : A \to B$ עבור $A, B \subseteq M$ מעוצמה קטנה מ־$\kappa$ אלמנטרי חלקי ניתן להרחיב לאוטומורפיזם.
\end{remark}
\begin{remark}
	עקבי עם ZFC שאין מונה $\lambda$ אינסופי בו $2^{\lambda} = \lambda^+$ אבל לכל מונה $\kappa$ יש תת־מודל של העולם (שמקיים ZFC) מכיל את $V_{\kappa}$ או את הקבוצות שעוצמתן ועוצמת איבריה $< \kappa$.
	אותו מודל מקיים כי לכל $\lambda$ מספיק גדול, $2^{\lambda} = \lambda^+$.
\end{remark}
\begin{corollary}
	$T$ שלמה אם יש $\lambda$ עבורו יש ל־$T$ מודל רווי יחיד מעוצמה $\lambda$.
\end{corollary}
\begin{proof}
	אם $\Nn_0, \Nn_1 \models T$ ו־$\Nn_0 \not\equiv \Nn_1$ אז $\Nn_0 \prec \Mm_0$ וכן $\Nn_1 \prec \Mm_1$ מרוויה אבל $\Mm_0 \cong \Mm_1$ ולכן שקולים אלמנטרית.
\end{proof}
\begin{theorem}[שקילות רוויים וחילוץ כמתים]
	התנאים הבאים שקולים עבור תורה $T$:
	\begin{enumerate}
		\item $T$ מחלצת כמתים
		\item אם $\Mm, \Nn \models T$ רוויים ומאותה עוצמה ו־$\Aa$ תת־מבנה נוצר סופית משותף ו־$\varphi$ נוסחת קיים פרימיטיבית אז $\Mm_A \models \varphi \implies \Nn_A \models \varphi$
	\end{enumerate}
	אם נניח בנוסף ש־$T$ שלמה נקבל שגם:
	\begin{enumerate}
		\item[3.] אם $\Mm \models T$ רווי, $\Aa \subseteq \Mm$ תת־מבנה נוצר סופית, $\Bb$ נוצר סופית, $f : \Aa \to \Bb$ איזומורפיזם אז לכל $a \in M$ ניתן להרחיב את $f$ ל־$\langle A \cup \{ a \} \rangle$
		\item[4.] אותו הדבר ל־$|A| < |M|$
	\end{enumerate}
\end{theorem}
\begin{proof}
	$1 \implies 2$: ראינו.
	...
	$2 \implies 1$:
	אם $\Nn_0, \Nn_1$ מודלים כלשהם של $T$ אז ניתן להחריב אותו ל־$\Mm_0 \prec \Mm, \Nn_0 \prec \Nn$ רוויים.
	לכן טענה 2 למעשה גוררת את המקרה בלי ההנחה על רוויה של $\Mm, \Nn$.

	$4 \implies 3$:
	נראה ש־$1 \implies 4$, QE גורר כי כל איזומורפיזם של תתי־מבנים הוא שיכון אלמנטרי חלקי.
	מרוויה יש הומוגניות ולכן ניתן להרחיב את $f$.

	$3 \implies 1$:
	נניח ש־$\Mm, \Nn$ רוויים ו־$\Aa$ תת־מבנה משותף.
	אז האיזומורפיזם $f : \Mm \leftrightarrow \Nn$ נותן בפרט איזומורפיזם בין $\Aa$ ל־$f^{-1}(A)$.
	נניח כי $a \in M$ מעיד על כך ש־$\varphi$ מתקיימת ב־$\Mm$.
	נרצה להרחיב את $g = f^{-1} \restriction A$ כך ש־$a$ יהיה בתחומה.
	נטען כי $b = f(g(a))$ מעיד על $\Nn$ מקיים את $\varphi$ עם הפרמטרים מ־$A$. \\
	$\varphi = \exists x\ \psi(x, c_0, \ldots, c_{n - 1})$ עבור $c_i \in A$.
	\[
		\Mm \models \psi(a, c_0, \ldots, c_{n - 1})
		\implies \Mm \models \psi(g(a), g(c_0), \ldots, g(c_{n - 1}))
	\]
	ולכן,
	\[
		\Nn \models \psi(f(g(a)), f(g(c_0)), \ldots, f(g(c_{n - 1})))
		\iff \Nn \models \psi(f(g(a)), c_0, \ldots, c_{n - 1})
		\implies \Nn \models \varphi(c_0, \ldots, c_{n - 1})
	\]
	כאשר $b = f(g(a))$.
\end{proof}
\begin{definition}[סדרת אי־בחינים]
	נניח ש־$\langle I, <_I \rangle$ סדר קווי ו־$\Mm$ מבנה. \\
	סדרה $\langle \bar{a}_i \mid i \in I \rangle$ עבור $\bar{a}_i \in M^k$ תיקרא סדרת אי־בחינים אם לכל נוסחה $\varphi$ ולכל $i_0 < \cdots < i_{n - 1}, j_0 < \cdots < j_{n - 1}$ ב־$I$ מתקיים,
	\[
		\Mm \models \varphi(\bar{a}_{i_0}, \ldots, \bar{a}_{i_{n - 1}})
		\leftrightarrow \varphi(\bar{a}_{j_0}, \ldots, \bar{a}_{j_{n - 1}})
	\]
\end{definition}
\begin{definition}[תת־קבוצות מגודל]
	נסמן ב־${[A]}^n$ את $\{ X \subseteq A \mid |X| = n \}$.
	$\mu \to {(\kappa)}_{\lambda}^r$ אם,
	לכל $f : {[\mu]}^r \to \lambda$ יש $A \subseteq \mu$ עם $|A| = \kappa$ כך ש־$f \restriction {[A]}^r$ קבועה.
\end{definition}
\begin{theorem}[רמזי]
	$\omega \to {(\omega)}_k^r$ לכל $r, k \in \NN$.
	כלומר לכל $f : {[\omega]}^r \to k$ יש תת־קבוצה $A \subseteq \omega$ עם $|A| = \aleph_0$ כך ש־$f \restriction {[A]}^r$ קבועה.
\end{theorem}
\begin{remark}
	$\omega_1 \not\to {(\omega_1)}_2^2$.
\end{remark}
\begin{proof}
	באינדוקציה על $r$.
	עבור $r = 0$ הטענה נכונה.
	ל־$r = 1$ שובך היונים. \\
	נניח כי הטענה מתקיימת ל־$r$ ונבחן את $f : {[\omega]}^{r + 1} \to k$.
	נגדיר ברקורסיה סדרת קבוצות $B_n \subseteq \omega$ אינסופיות ל־$n$ טבעי באופן הבא: לשם הסימון $B_{-1} = \omega$ ונבחן את $g : {[B_{n - 1} \setminus (n + 1)]}^r \to k$ המוגדרת על־ידי $g(a) = f(a \cup \{n\})$.
	מהנחת האינדוקציה $B_n \subseteq B_{n - 1}$ אינסופית ו־$c_n < k$ כך ש־$g \restriction {[B_n]}^r$ פונקציה קבועה ערך $c_1$. \\
	קיבלנו שאם $n_0, \ldots, n_r$ מקיימים $n_0 < \cdots < n_r$ ו־$n_1, \ldots, n_r \in B_{n_0}$ אז $f(\{n_0, \ldots, n_r\}) = c_{n_0}$. \\
	נגדיר באינדוקציה את הסדרה של האיברים $s_0 = 0$ וכן $s_{n + 1} = \min(B_{s_n} \setminus (s_n + 1))$ ולבסוף $S = \{ s_n \mid n < \omega \}$.
	נגדיר $s_n \rightharpoonup c_{s_n}$, זו קבוצה אינסופית ב־$k$ ולכן יש תת־קבוצה אינסופית קבועה. \\
	נסמן את תת־הקבוצה הזו ב־$A$ ונקבל ש־$f \restriction {[A]}^{r + 1}$ קבועה.
\end{proof}
\begin{theorem}[חילוץ אי־בחינים]
	יהי $\Mm$ מבנה ו־$\langle I, <_I \rangle$ סדר קווי, $\langle J, <_J \rangle$ קווי.
	נניח ש־$\langle \bar{a}_i \mid i \in I \rangle$ סדרה של איברים מ־$M^n$.
	אז יש הרחבה אלמנטרית $\Mm \prec \Nn$ וסדרת איברים $\langle \bar{b}_j \mid j \in J \rangle$ עבור $\Nn$ כל שלכל נוסחה $\varphi$ אם יש $j_0 < \cdots < j_{k - 1}$ ב־$J$,
	כך ש־$\Nn \models \varphi(\bar{b}_{j_0}, \ldots, \bar{b}_{j_{k - 1}})$ אז יש $i_0 < \cdots < i_{k - 1}$ ב־$I$ כך ש־$\Mm \models \varphi(\bar{a}_{i_0}, \ldots, \bar{a}_{i_{k - 1}})$.
\end{theorem}
\begin{proof}
	בלי הגבלת הכלליות $n = 1$, נוסיף קבועים $\langle c_j \mid j \in J \rangle$ ונסתכל על,
	\begin{align*}
		\Sigma
		= & \diag(\Mm) \\
		& \cup \{ \varphi(c_{j_0}, \ldots, c_{j_{k - 1}}) \leftrightarrow \varphi(c_{j_0'}, \ldots, c_{j_{k - 1}'}) \mid j_0 < \cdots < j_{k - 1}, j_0' < \cdots < j_{k - 1}', \varphi \in \form \} \\
		& \cup \{ \varphi(c_{j_0}, \ldots, c_{j_{k - 1}}) \mid \forall i_0 < \cdots < i_{k - 1},\ \Mm \models \varphi(a_{i_0}, \ldots, a_{i_{k - 1}}) \}
	\end{align*}
	נראה כי $\Sigma$ ספיקה סופית.
	תהי $\Sigma_0 \subseteq \Sigma$ סופית.
	מורכבת מאי־בחינות של מספר סופי של צבעים איתם לנוסחות $\rho_0, \ldots, \rho_{k - 1}$ לכל היותר עם $r$ משתנים חופשיים.
	נגדיר צביעה על $I$, $f(i_0, \ldots, i_{r - 1})$ הוא ערכי האמת של $(\rho_j(c_{i_0}, \ldots, c_{i_{k - 1}}) \mid j < k)$.
	לכן יש $I_0 \subseteq I$ אינסופית חדגונית ולכן יש דרך להתאים את הדברים שהופיעו ב־$\Sigma_0$ לאיברים מ־$(a_i \mid i \in I)$ כך ש־$\Sigma_0$ תתקיים.
\end{proof}
\begin{definition}[טיפוס סקולם]
	בהינתן $(I, <)$ סדר קווי וסדרת אי־בחינים $\langle a_i \mid i \in I \rangle$,
	הטיפוס EM הוא כל הנוסחות מהצורה $\varphi(x_0, \ldots, x_{n - 1})$ כך שיש לכל $i_0 < \cdots < i_{n - 1}$ ב־$I$, $\Mm \models \varphi(a_{i_0}, \ldots, a_{i_{n - 1}})$.
\end{definition}

\section{שיעור 11 --- 4.1.2026}
\subsection{פונקציות סקולם}
ניזכר בהגדרת פונקציות סקולם, הן פונקציות המוגדרות עבור נוסחה ומחזירות עבורה איברים שמקיימים אותה.
\begin{definition}[פונקציות סקולם גדירות]
	למבנה $\Mm$ יש פונקציות סקולם גדירות אם לכל $\varphi$ יש $f_{\varphi}$ פונקציות סקולם עבור $\varphi$ וגדירה ללא פרמטרים.
	אם בנוסף ניתן לקחת את $f_{\varphi}$ להיות שם־עצם במבנה אז נאמר של־$\Mm$ יש פונקציות סקולם מובנות (built-in).
\end{definition}
\begin{remark}
	פונקציות סקולם גדירות או מובנות הן תכונות של $\Th(\Mm)$.
\end{remark}
\begin{remark}
	אם לתורה $T$ יש פונקציות סקולם מובנות אז $T$ מחלצת כמתים,
	\[
		T \models (\exists x\ \varphi) \leftrightarrow \varphi_{f_{\varphi}(x)}^x
	\]
\end{remark}
\begin{definition}[פונקציה גדירה]
	פונקציה היא גדירה אם הגרף שלה הוא קבוצה גדירה,
	כלומר יש נוסחה $\psi$ עם משתנים $y_0, \ldots, y_{k - 1}, z$ כל שמתקיים $f_{\varphi}(\bar{y}) = z \iff \psi(\bar{y}, z)$.
\end{definition}
\begin{example}
	ל־RCF יש פונקציות סקולם גדירות.
	אם $\varphi$ נוסחה עם משתנים חופשיים $x, y_0, \ldots, y_{k - 1}$ אז מחילוץ כמתים $\varphi$ שקולה לאוסף שוויונות ואי־שוויונות על שמות עצם ב־$x, y$.
	לכן ניתן למצוא $w_0, w_1$ שתלויים בצורה גדירה ב־$y$ וכך גם ב־$x$ כך ש־$x$ מקיים את $\varphi$ כאשר $x \in (w_0, w_1) \lor x < w_0 \lor x > w_1 \lor x = w_0 = w_1$.
\end{example}
\begin{example}
	ל־PA יש פונקציות סקולם גדירות.
\end{example}
\begin{remark}
	לכל תורה $T$ בשפה $L$ יש הרחבה ל־$L'$ ו־$T'$ כך ש־$|L'| \le |L| + \aleph_0$ ול־$T$ יש פונקציות סקולם מובנות.
\end{remark}
\begin{proof}
	נגדיר סדרת שפות $L_n$ על־ידי $L_0 = L$ וכן $L_n$ מכיל לכל נוסחה ב־$L_{n - 1}$ סימן פונקציה $f_{\varphi}$ ו־$T_n$ מכילה את,
	\[
		\forall \bar{y}\ (\exists x\ \varphi(x, \bar{y}) \to \varphi(f_{\varphi}(\bar{y}), \bar{y}))
	\]
	ואז $L = \bigcup L_n, T' = \bigcup T_n$.
\end{proof}
\begin{remark}
	אם ל־$T$ יש פונקציות סקולם מובנות ו־$A \subseteq M$ עבור $\Mm \models T$, אז $\langle A \rangle \prec \Mm$.
\end{remark}
\begin{theorem}[הרחבות עם מימוש חסום של טיפוסים]
	נניח ש־$\Mm \models T$ ו־$|M| \ge \aleph_0$, אז לכל $\kappa \ge |T|$ יש מודל $\Nn \models T$ מעוצמה $\kappa$,
	כך שלכל $A \subseteq N$ בת־מנייה $\Nn$ מממש לכל היותר $\aleph_0$ טיפוסים מתוך $S_1(A)$.
\end{theorem}
\begin{proof}
	$\Mm$ אינסופי ולכן ניקח סדרה אינסופית של איברים שונים $\langle a_i \mid i < \omega \rangle$.
	ממשפט האי־בחינים יש מודל $\Nn$ שקול אלמנטרית על סדרת האי־בחינים הדומים ל־$a_i$ באורך הסודר $\kappa$, $\langle b_i \mid i < \kappa \rangle$.
	בלי הגבלת הכלליות ל־$T$ יש פונקציות סקולם מובנות.
	בלי הגבלת הכלליות $\langle b_i \mid i < \kappa \rangle$ שייכת למודל המפלצת של $T$ ולכן נניח ש־$\Nn = \langle \{ b_i \mid i < \kappa \} \rangle$.
	
	תחילה נחשב כמה טיפוסים יש מהצורה,
	\[
		B \subseteq \{ b_i \mid i < \kappa \},
		tp(b_{j_0}, \ldots, b_{j_{n - 1}} / B)
	\]
	לכל נוסחה $\varphi$ ופרמטרים $b_{k_0}, \ldots, b_{k_{r - 1}}$ מתקיים $\varphi(x_0, \ldots, x_{n - 1}) \in p$, \\
	תלוי רק במיקום של האינדקסים $j_0, \ldots, j_{n - 1}$ ביחס ל־$k_0, \ldots, k_{n - 1}$.
	לכן ניתן לחשב את $p$ מתוך המידע,
	\[
		\{ j \in \RR \mid j < j_0 \}, \{ j \in \RR \mid j_0 < j < j_1 \}, \ldots
	\]
	לכן כמות האפשרויות למקטעים אלו היא בת־מנייה.
	כעת עבור $A \subseteq N$ בת־מנייה ו־$A \subseteq Sk(B) = \langle B \rangle$ עבור $Sk$ סגור סקולם ו־$B \subseteq \{ b_i \mid i < \kappa \}$ בת־מנייה.
	אם $a \in N$ אז $a = t(b_{j_0}, \ldots, b_{j_{k - 1}})$ ולכן ניתן לחשב את $tp(a / A)$ מתוך $tp(b_{j_0}, \ldots, b_{j_{k - 1}} / B)$ גורר שמ־$S_1(A)$, $\Nn$ מממש מספר בן־מנייה של טיפוסים.
\end{proof}

\begin{definition}[קפא־יציבה]
	יהי $\kappa$ מונה אינסופי.
	תורה $T$ היא $\kappa$־יציבה אם לכל $A \subseteq \Cc_T$ מעוצמה $\le \kappa$ מתקיים $|S_1(A)| \le \kappa$.
\end{definition}
\begin{example}
	DLO איננה $\kappa$־יציבה.
	נשתמש בעובדה הבאה: לכל מונה $\kappa$ יש סדר קווי צפוף מעוצמה $\kappa$ שכמות החתכים בו גדולה מ־$\kappa$,
	כאשר חתך $X$ בסדר קווי $\Ll$ הוא קבוצה לא ריקה סגורה כלפי מטה.
	אם ניקח את $A$ להיות סדר זה אז $A$ משוכן לתוך $\Cc_{\operatorname{DLO}}$ ו־$\kappa < |S_1(A)|$.
\end{example}
\begin{remark}
	יתכן ש־$T$ איננה $\kappa$־יציבה אבל יש $A$ עבורו $S_1(A)$ קטן. \\
	נבחן את $\{ x < \zeta \mid \zeta > \sqrt{2} \}, \{ x > \zeta \mid \zeta < \sqrt{2} \}, \{ x = \pm \sqrt{2} \}$, אז $(\RR, <)$ מממש $2^{\aleph_0}$ טיפוסים ומשמיט $2^{\aleph_0}$ טיפוסים.
\end{remark}
\begin{lemma}
	התנאים הבאים שקולים:
	\begin{enumerate}
		\item $T$ היא $\kappa$־יציבה
		\item לכל $A \subseteq \Cc_T$ עם $|A| \le \kappa$ מתקיים $|S_n(A)| \le \kappa$ לכל $n < \omega$
		\item $|S_n(\emptyset)| \le \kappa$ ולכל מודל $\Mm$ של $T$ מעוצמה $\le \kappa$ מתקיים $\forall n < \omega,\ |S_n(M)| \le \kappa$
		\item $|S_n(\emptyset)| \le \kappa$ ולכל מודל $\Mm$ של $T$ מעוצמה $\le \kappa$ מתקיים $|S_1(M)| \le \kappa$
	\end{enumerate}
\end{lemma}
\begin{remark}
	אם $\forall n\ |S_n(\emptyset)| \le \kappa$ אז יש $L' \subseteq L$ מעוצמה קטנה מ־$\kappa$ כך שלכל נוסחה ב־$L$ שקולה לנוסחה ב־$L'$.
\end{remark}
\begin{proof}
	$1 \implies 2$:
	באינדוקציה על $n$.
	ל־$n = 0, 1$ הטענה נובעת מהגדרה.
	נניח כי לכל $|A| < \kappa$ מתקיים $|S_n(A)| \le \kappa$ ונניח ש־$\langle p_{\alpha} \mid \alpha < \kappa^+ \rangle$ סדרת טיפוסים ב־$S_{n + 1}(A)$.
	אם $p_0$ טיפוס ב־$x_0, \ldots, x_n$ משתנים חופשיים ויהי $q_{\alpha}$ הטיפוס ב־$x_1, \ldots, x_n$ המוגדר על־ידי,
	\[
		q_{\alpha}
		= \{ \varphi \mid FV(\varphi) \subseteq \{ x_1, \ldots, x_n \}, \varphi \in p_{\alpha} \}
	\]
	עבור $q_{\alpha} \in S_n(A)$.
	אז יש $I \subseteq \kappa^+$ בעוצמה $\kappa^+$ כך שלכל $\alpha, \beta \in I$ מתקיים $q_{\alpha} = q_{\beta}$.
	נסמן את הטיפוס המשותף $q_*$.
	נבחר $b_1, \ldots, b_n \in \Cc_T$ שמממשים את $q_*$ ונגדיר,
	\[
		p_{\alpha}'
		= \{ \varphi(x_0, b_1, \ldots, b_n) \mid \varphi \in p_{\alpha} \}
	\]
	$p_{\alpha}'$ עקבי מכיוון שהנוסחה $\exists x_0\ \varphi(x_0, x_1, \ldots, x_n) \in q_*$ עבור $\varphi \in p_{\alpha}$.
	מ־$\kappa$־יציבות יש $\alpha < \beta$ ב־$I$ כך ש־$\pi_{\alpha}' = p_{\beta}'$ אז $p_{\alpha} = p_{\beta}$.

	$2 \implies 3 \implies 4$ ברור.

	$4 \implies 1$:
	אם $A \subseteq \Cc_T$ מעוצמה $\le \kappa$ אז מלוונהיים־סקולם ומכך שהשפה שקולה לשפה קטנה, יש $\Aa \subseteq \Mm \models T, |M| \le \kappa$ ובבירור $|S_1(A)| \le |S_1(M)|$.
\end{proof}
השתמשנו בכך שאם מתקיים כי לכל $\varphi$ נוסחה ב־$L$ יש נוסחה $\psi$ ב־$L'$ כך שמתקיים,
\[
	T \models \forall \bar{x}\ (\varphi \leftrightarrow \psi)
\]
ונתון $\Mm \models T \restriction L'$ אז יש הרחבה יחידה שלו למודל של $T$ בשפה $L$.
\begin{example}
	נבחן את $\operatorname{ACF}_p$.
	הטיפוסים הם או טיפוס אלגברי, נקבע על־ידי הפולינום המינימלי או לא אלגברי, וזה טיפוס יחיד.
\end{example}
\begin{remark}
	תהי $T$ תורה בשפה בת־מנייה שהיא $\kappa$־קטגורית ל־$\kappa$ לא בת־מנייה. אז $T$ היא $\omega$־יציבה.
\end{remark}
\begin{proof}
	נניח ש־$\Mm$ בן־מנייה וצריך להראות שכמות הטיפוסים ב־$S_1(M)$ בת־מנייה.
	נניח בשלילה שלא, כלומר $S_1(M)| > \aleph_0$ ויהי $\Nn_0$ מודל מעוצמה $\kappa$, $\Mm \prec \Nn_0$ ו־$\Nn$ מממש לפחות $\aleph_1$ מתוך הטיפוסים ב־$S_1(M)$.
	מצד שני מאי־בחינים בנינו מודל $|N_1| = \kappa$ לשם התקיים כי $\forall A \subseteq N_1, |A| \le \aleph_0$.
	$\Nn_1$ מממש לכל היותר אוסף בן־מנייה של טיפוסים מ־$S_1(A)$.
	מ־$\kappa$־קטגוריות נקבל סתירה, זאת שכן $\Nn_0 \cong \Nn_1$ מועד על־ידי $f$, אבל $A = f(M)$.
\end{proof}
\begin{definition}[תורה טרנסצנדטלית לחלוטין]
	תורה טרנסצנדטלית לחלוטין אם ורק אם לא מתקיימת תכנות העץ הבינארי,
	כאשר $T$ מקיימת את תכונת העץ הבינארי אם יש נוסחות $\langle \varphi_s(\bar{x}) \mid s \in 2^{< \omega} \rangle$ עם פרמטרים ב־$\Cc_T$ כך שלכל $\eta \in 2^{\omega}$ האוסף,
	\[
		\{ \varphi_{\eta \restriction n}(\bar{x}) \mid n < \omega \}
	\]
	עקבית, וכן $\varphi_{s \smallfrown \{ 0 \}}(\bar{x}) \land \varphi_{s \smallfrown \{ 1 \}}(\bar{x})$ לא עקבית.
\end{definition}
\begin{proposition}
	אם $T$ היא $\omega$־יציבה, אז $T$ טרנסצנדטלית לחלוטין.
\end{proposition}
\begin{proof}
	אחרת, יהי $A$ אוסף הפרמטרים שמופיעים ב־$\langle \varphi_s \mid s \in 2^{< \omega} \rangle$ מקיים $|A| \le \aleph_0$, ולכן $|S_1(A)| \le \aleph_0$.
	אבל לכל $\eta \in 2^{\omega}$ הטיפוס החלקי $p_{\eta} = \{ \varphi_{\eta \restriction n} \mid n < \omega \}$ מתרחב באופן שונה כי אם $\eta \ne \eta'$ ו־$n$ נקודת חוסר ההסכמה הראשונה אז,
	\[
		\lnot \varphi_{\eta' \restriction n + 1}, \varphi_{\eta \restriction n + 1} \in p_{\eta},
		\qquad
		\lnot \varphi_{\eta \restriction n + 1}, \varphi_{\eta' \restriction n + 1} \in p_{\eta}
	\]
	וקיבלנו שיש $2^{\aleph_0}$ טיפוסים שונים.
\end{proof}
\begin{proposition}
	אם $T$ טרנסצנדטלית לחלוטין אז $T$ היא $\kappa$־יציבה לכל $|T| \le \kappa$.
\end{proposition}
\begin{proof}
	נניח ש־$T$ איננה $\kappa$־יציבה ויהי $\Mm \models T, |M| = \kappa$ כך ש־$|S_1(M)| > \kappa$.
	נשים לב כי יש $\kappa$ קבוצות פתוחות $U_{\varphi} = \{ p \mid \varphi \in p \}$ ויש יותר מ־$\kappa$ נקודות במרחב.
	נאמר שנוסחה $\varphi$ היא גדולה אם $|U_{\varphi}| > \kappa$ ואכן למשל $x = x$ היא גדולה. \\
	נניח כי $\varphi$ היא נוסחה גדולה ונראה כי יש $\psi$ כך שגם $\varphi \land \psi$ ו־$\varphi \land (\lnot \psi)$ שתיהן גדולות.
	אחרת נניח ש־$\varphi$ גדולה ולא ניתן לעשות פיצול כזה, אז לכל $\psi$ מתקיים כי בדיוק אחת מבין $\psi, \lnot \psi$ מקיימת כי גימומה עם $\varphi$ גדולה,
	שהרי $U_{\varphi} = U_{\varphi \land \psi} \cup U_{\varphi \land \lnot \psi}$. \\
	נגדיר $\Gamma = \{ \psi \mid \varphi \land \psi \text{ is large} \}$, זהו טיפוס כיוון שאם $\psi_0, \ldots, \psi_{n - 1}$ ב־$\Gamma$ אז בהכרח $\varphi \land \psi_0 \land \cdots \land \psi_{n - 1}$ גדולה, שכן,
	\[
		U_{\varphi \land \psi_0 \land \cdots \land \psi_{n - 1}}
		= U_{\varphi} \setminus \bigcup_{i < n} U_{\varphi \land \lnot \psi_i}
	\]
	גדולה ובפרט לא ריקה.
	לכן $\Gamma$ סגורה לגימום, עקבית ודעתנית, אז $\Gamma$ טיפוס.
	\[
		U_{\varphi}
		= \bigcup_{\psi, \varphi \land \psi \text{ are small}} U_{\varphi \land \psi} \cup \{ \Gamma \}
	\]
	ולכן $|U_{\varphi}| \le \kappa \cdot \kappa + 1 = \kappa$ בסתירה.

	כעת נגדיר ברקורסיה את $\varphi_s$ על־ידי $\varphi_{\langle \rangle} = x = x$, ובהינתן שהגדרנו את $\varphi_s$ אז יש $\psi$ כך ש־$\varphi_s \land \psi, \varphi_s \land \lnot \psi$ גדולות ונגדיר,
	\[
		\varphi_{s \smallfrown \langle 0 \rangle} = \varphi \land \psi,
		\qquad
		\varphi_{s \smallfrown \langle 1 \rangle} = \varphi \land (\lnot \psi)
	\]
	וכעת לכל $\eta \in 2^{\omega}$ נקבל ש־$\{ \varphi_{\eta \restriction n} \mid n < \omega \}$ עקבית כי כל תת־הקבוצות שלה חלשה מ־$\varphi_{\eta \restriction n}$ עבור $n$ כלשהו.
\end{proof}
\begin{corollary}
	$\omega$־יציבות גוררת טרנסצנדטלית לחלוטין גוררת  $\kappa$־יציבות לכל $\kappa \ge |T|$.
\end{corollary}
\begin{example}
	יתכן ש־$T$ היא $\kappa$־יציבה לאיזושהי $\kappa$ לא בת־מנייה ולא $\omega$־יציבה.
	נגדיר סדרת יחסי שקילות מתעדנים $E_0, E_1, \ldots$ עם מספר אינסופי של מחלקות שקילות אינסופיות ו־$E_{n + 1}$ מחלק כל מחלקת שקילות של $E_n$ לאינסוף חלקים.
	יש $2^{\aleph_0}$ טיפוסים שונים עם $\aleph_0$ פרמטרים לפי שיוכים למחלקות שקילות.

	מהצד השני אם $\Mm$ מודל בעוצמה $\kappa$ ו־$p \in S_1(M)$ אז $p$ נקבע על־ידי מחלקת השקילות ה־$E_n$ של $x$ ביחס מ־$\Mm$.
	לכן $|S_1(M)| \le \kappa^{\aleph_0}$ ואם $\kappa = 2^{\aleph_0}$ אז $|S_1(M)| \le \kappa$.
\end{example}
\begin{theorem}[קיום מודלים רוויים]
	אם $T$ ללא מודלים סופיים ו־$|T| \le \kappa$ היא $\kappa$־יציבה אז לכל $\lambda \ge \kappa$ סדיר יש ל־$\Mm$ מודל $\lambda$־רווי מעוצמה $\kappa$.
\end{theorem}
\begin{proof}
	נתחיל מ־$\Mm_0 \models T$ בעוצמה $\kappa$.
	$|S_1(\Mm_0)| \le \kappa$ ולכן יש $\Mm_0 \prec \Mm_1$ שמממש כל טיפוס מ־$S_1(M)$ בעוצמה $\kappa$.
	נמשיך כך ונבנה סדרת מודלים $\langle \Mm_{\alpha} \mid \alpha < \lambda \rangle$ כך שלכל $\alpha < \beta$ מתקיים $\Mm_{\alpha} < \Mm_{\beta}$ וכל טיפוס מ־$S_1(\Mm_{\alpha})$ מתממש ב־$\Mm_{\beta}$.
	$|M_{\alpha}| = \kappa$.
	נסתכל על $\Mm_{\lambda}$, אם $A \subseteq M_{\lambda}$ עם $|A| < \lambda$ אז מסדירות $\lambda$ יש $\alpha < \lambda$ כך ש־$A \subseteq M_{\alpha}$.
	לכן אם $p \in S_1(A)$ אז $p$ התממש ב־$\Mm_{\alpha + 1}$ ולכן גם ב־$\Mm_{\lambda}$.
\end{proof}
\begin{corollary}
	לכל מונה $\kappa$ ותורה $T$ בשפה בת־מנייה היא $\kappa$־קטגורית אם ורק אם כל מודל בעוצמה $\kappa$ של $T$ רווי.
\end{corollary}
\begin{proof}
	אם $T$ איננה $\kappa$־יציבה אז יש מודל $\Mm$ שעוצמתו $\kappa$ ו־$\kappa < |S_1(M)|$ ומצד שני יש מודל $\Nn$ שנבנה מאי־בחינים שבו זה לא מתרחש.
	מקטגוריות $T$ נקבל שהיא $\kappa$־יציבה.
	אז $\kappa$־סדיר גורר שיש מודל רווי ולכן כל מודל $\kappa$־רווי.
	אם $\kappa$ לא סדיר אז $\kappa$ מונה גבולי.
	נניח ש־$p \in S_1(A)$ עבור $|A| < \lambda$ אז $|A| < \lambda^+ < \kappa$ ויש מודל $T$ שהוא $\lambda^+$־רווי בעוצמה $\kappa$.
	נקבל מקטגוריות שכל מודל הוא כזה ולכן $p$ מתממש.
\end{proof}

\section{שיעור 12 --- 11.1.2026}
בשיעור הקודם ראינו שאם $T$ היא תורה $\kappa$־קטגורית ו־$|T| \le \kappa$, אז יש לה מודל רווי מעוצמה $\kappa$.

\subsection{מודלים ראשונים ולא אטומיים}
\begin{definition}[מודל ראשוני]
	מודל $\Mm$ הוא ראשוני מעל $A \subseteq M$ אם לכל מודל $\Nn$ ושיכון אלמנטרי חלקי $f : A \to \Nn$ ניתן להרחיב את $f$ לשיכון אלמנטרי מ־$\Mm$ ל־$\Nn$.
\end{definition}
\begin{definition}[מודל ניתן לבנייה]
	$\Mm$ ניתן לבנייה מתוך $A$ אם יש מנייה של $M$, $\langle a_{\alpha} \mid a < \alpha_* \rangle$ כך שמתקיים $tp(a_{\alpha} / A \cup \{ a_{\gamma} \mid \gamma < \alpha \})$ מבודד.
	במקרה זה נאמר ש־$a_{\alpha}$ אטומי מעל $A \cup \{ a_{\gamma} \mid \gamma < \alpha \}$.
	קבוצה $B$ תיקרא אטומית מעל $A$ אם לכל $\bar{b} \in B^{< \omega}$ מתקיים ש־$tp(\bar{b} / A)$ מבודד.
\end{definition}
\begin{lemma}
	אם $\Mm$ ניתן לבנייה מתוך $A$ אז $\Mm$ ראשוני.
\end{lemma}
\begin{proof}
	נניח ש־$\Nn$ מודל ו־$f : A \to \Nn$ שיכון אלמנטרי חלקי.
	נניח ש־$\langle b_{\alpha} \mid \alpha < \alpha_* \rangle$ מעידה על כך ש־$\Mm$ ניתנת לבנייה.
	בלי הגבלת הכלליות $A = \langle b_{\gamma} \mid \gamma < \gamma_* \rangle$, ונסמן את $f = f_{\gamma_*}$.
	באינדוקציה יהי $\alpha \le \alpha_*$ ונניח כי $f_{\beta}$ מוגדר לכל $\beta < \alpha$. אם $\alpha$ גבולי אז $f_{\alpha} = \bigcup_{\beta < \alpha} f_{\beta}$.
	אם $\alpha$ עוקב אז $\alpha = \beta + 1$ ולכן $tp(b_{\beta} / A \cup \{ b_{\gamma} \mid \gamma < \beta + 1 \})$ טיפוס המבודד על־ידי $\psi$.
	לכן $(f_{\beta_*}) q$ מבודד על־ידי ${(f_{\beta})}_* \psi$ המתממשת מאלמנטריות.
	יהי $c_{\beta} \in N$ מימוש שלה, אז נגדיר $f_{\alpha} = f_{\beta} \cup \{ \langle b_{\beta}, c_{\beta} \rangle \}$.
\end{proof}
\begin{lemma}
	תהי $T$ תורה טרנסצנדטלית־לחלוטין ו־$A \subseteq \Cc_T$, אז הטיפוסים המבודדים צפופים ב־$S_1(T_A)$, כאשר $T_A = \Th(\Cc_A)$.
\end{lemma}
\begin{proof}
	נניח בשלילה שלא ותהי $\varphi$ נוסחה עקבית כך ש־$U_{\varphi}$ לא מכילה נקודות מבודדות ונבנה ברקורסיה עץ פיצולים של $\varphi$ על־ידי $\varphi_{\langle \rangle} = \varphi$.
	עבור $\varphi_s$ ל־$s \in 2^{< \omega}$ ידוע ש־$\varphi_s$ לא מבודדת טיפוס אז יש $\psi$ כך ש־$\varphi_s \land \psi, \varphi_s \land \lnot \psi$ עקביות ונגדיר אותן כהמשך העץ.
\end{proof}
\begin{corollary}
	אם $T$ היא טרנסצנדטלית־לחלוטין אז כל $A \subseteq \Cc_T$ ניתנת להרחבה למודל ראשוני מעל $A$.
\end{corollary}
\begin{proof}
	נסמן $A_0 = A$ ונניח ש־$\langle \psi_{0, \alpha}(x) \mid \alpha < \alpha_0 \rangle$ מנייה של הנוסחות עם משתנה חופשי $x$ ופרמטרים מ־$A_0$ שעקביות ב־$\Cc_T$.
	מהטענה הקודמת לכל $\psi_{0, i}$ יש טיפוס מוגדר המכיל אותה וניקח את $_{0, i}$ לממש אותו ב־$\Cc$, נגדיר $A_0 \subseteq A_1 = \{ b_{0, i} \mid i < \alpha_0 \}$.
	נמשיך כך ונגדיר את $A_n$ לכל $n < \omega$ ונשים לב שאם $\psi$ נוסחה עם משתנה חופשי $x$ ופרמטרים מ־$A_n$ שמתממשת ב־$\Cc$ אז היא מתממשת ב־$A_{n + 1}$ ולכן $A \subseteq \bigcup_{n < \omega} A_n \prec \Cc$ ניתן לבנייה.
	הסדרה שמתקבלת מהסרת החזרות השרשור של $\langle \langle b_{i, \alpha} \mid \alpha < \alpha_i \rangle \mid i < \omega \rangle$ מוגדרת כך ש־$\bigcup A_n$ ניתן לבנייה.

	נניח כי $\langle b_{\alpha} \mid \alpha < \alpha_* \rangle$ סדרה המקיימת ש־$tp(b_{\alpha} / A \cup \{ b_{\gamma} \mid \gamma < \alpha \})$ מבודד.
	הנוסחה המעידה על כך מכילה מספר סופי של פרמטרים $b_{\alpha_0}, \ldots, b_{0_{n - 1}}$. בפרט $tp(b_{\alpha} / A \cup \{ b_{\alpha_i} \mid i < n \})$ מבודד.
\end{proof}
\begin{proposition}
	נניח ש־$\Mm$ ניתן לבנייה מעל $A$, אז $\Mm$ אטומי מעל $A$.
\end{proposition}
\begin{proof}
	נתחיל בהוכחת הלמה הבאה:
	נניח ש־$\bar{a}, \bar{b}$ סדרות סופיות.
	אז $tp(\bar{a} \smallfrown \bar{b})$ מבודד אם ורק אם $tp(\bar{a})$ מבודד ו־$tp(\bar{b} / \bar{a})$ מבודד.

	נניח ש־$tp(\bar{a} \smallfrown \bar{b})$ מבודד על־ידי נוסחה $\psi(\bar{x}, \bar{y})$.
	אם $\varphi(\bar{x}) \in tp(\bar{a})$ אז $\forall \bar{x} \forall \bar{y}\ ( \psi(\bar{x}, \bar{y}) \to \varphi(\bar{x}))$.
	בנוסף $\exists \bar{x} \exists \bar{y}\ \psi(\bar{x}, \bar{y})$ ולכן $\exists \bar{y}\ \psi(\bar{x}, \bar{y})$ נמצא ב־$tp(\bar{a})$ וגם $\forall \bar{x} ((\exists \bar{y}\ \psi(\bar{x}, \bar{y}) \to \varphi(\bar{x})))$.
	נסיק שגם $\exists \bar{y}\ \psi(\bar{x}, \bar{y})$ מבודד את $tp(\bar{a})$.
	$tp(\bar{b} / \bar{a})$ מבודד על־ידי $\psi(\bar{a}, \bar{b})$ כי לכל $\rho(\bar{x}, \bar{y}) \in tp(\bar{a} \smallfrown \bar{b})$ מתקיים $\forall \bar{x} \forall \bar{y}\ (\psi \to \rho)$.
	בפרט מתקיים $\forall \bar{y}\ (\psi(\bar{a}, \bar{y}) \to \rho(\bar{a}, \bar{y}))$.

	אם $tp(\bar{a})$ מבודד על־ידי $\chi$ ו־$tp(\bar{b} / \bar{a})$ מבודד על־ידי $\xi$,
	אז $\chi(\bar{x}) \land \xi(\bar{x}, \bar{y})$ מבודד את $tp(\bar{a} \smallfrown \bar{b})$.
	אם $\psi(\bar{x}, \bar{y})$ בטיפוס $tp(\bar{a} \smallfrown \bar{b})$ אז $\chi(\bar{x}) \to \exists \bar{y}\ \psi(\bar{x}, \bar{y})$ ובנוסף,
	\[
		\forall \bar{y}\ (\xi(\bar{a}, \bar{y}) \to \psi(\bar{a}, \bar{y})
		\implies \chi(\bar{x}) \to \forall \bar{y}\ (\xi(\bar{x}, \bar{y}) \to \psi(\bar{x}, \bar{y})))
	\]

	נעבור להוכחת הטענה.
	נניח ש־$\langle b_{\alpha} \mid \alpha < \alpha_* \rangle$ מעידה על כך ש־$\Mm$ ניתן לבנייה מעל $A$.
	נוכיח באינדוקציה על $\alpha \le \alpha_*$ שאם $babr = \langle \langle b_{\alpha_0}, \ldots, b_{\alpha_{k - 1}} \rangle$.
	אם $\alpha_0, \ldots, \alpha_{k - 1} < \alpha$ אז $tp(\bar{b})$ מבודד.
	נניח שהטענה מתקיימת לכל $\beta < \alpha$ אז אם $\alpha$ גבולי אז לכל $\alpha_0, \ldots, \alpha_{k - 1} < \alpha$ יש $\beta < \alpha$ כך ש־$\alpha_0, \ldots, \alpha_{k - 1} < \beta$ ולכן מהנחת האינדוקציה $tp(\bar{b})$ מבודד.
	אם $\alpha = \beta + 1$ אז גם $\alpha_0, \ldots, \alpha_{k - 1} < \beta$. אחרת בלי הגבלת הכלליות $\alpha_0 = \beta$.
	$tp(b_{\beta} / A \cup \{ b_{\gamma} \mid \gamma < \beta \})$ מבודד,
	בפרט יש $\gamma_0, \ldots, \gamma_{n - 1} < \beta$ פרמטרים בנוסחה המבודדת.
	בהתאם $tp(b_{\gamma} / A \cup \{ b_{\gamma_i} \mid i < n \})$ מבודד.
	אז מהלמה $tp(\langle b_{\gamma_0}, \ldots, b_{\gamma_{n - 1}} / A)$ מבודד ובנוסף מהנחת האינדוקציה $tp(\langle b_{\alpha_0}, \ldots, b_{\alpha_{n - 1}} / A)$ מבודד.
	נשים לב שכל הפרמטרים $b_{\gamma_0}, \ldots, b_{\gamma_{n - 1}}$ למעשה מבודדים את כל $tp(b_{\beta} / A \cup \{ b_{\gamma} \mid \gamma < \beta \})$ בפרט מבודדים גם את,
	\[
		tp(b_{\beta} / A \cup \{ b_{\alpha_i} \mid 0 < i < k \} \cup \{ b_{\gamma_j} \mid j < n \})
	\]
	אז גם,
	\[
		tp(\langle b_{\alpha_i} \mid 0 < i < k \rangle \smallfrown \langle b_{\gamma_j} \mid j < n \rangle)
	\]
	מבודד.
	הסיבה לכך היא ש־$tp(b_{\beta}, \bar{a} \cup \bar{c} / A)$ מבודד ומאינדוקציה $tp(\bar{a} \smallfrown \bar{c} / A)$ מבודד.
	נסיק שגם $tp(\langle b_{\alpha_i} \mid i < k \rangle \smallfrown \langle b_{\gamma_i} \mid j < n \rangle)$ מבודד, ולכן גם $tp(\langle b_{\alpha_i} \mid i < k \rangle / A)$ מבודד.
\end{proof}
\begin{corollary}
	תהי $T$ תורה ו־$A \subseteq \Cc_T$ קבוצה.
	אז יש מודל ראשוני מעל $A$ והוא יחיד ואטומי.
\end{corollary}
מה שצריך להראות זה שאם $\Mm$ הוא ראשוני אז הוא אטומי.
אכן, קיים מודל אטומי $\Nn$ מעל $A$, אז $\Mm$ משוכן לתוך $\Nn$ ולכן קיימת $\bar{b} \in M^{< \omega}$ הטיפוס שלה לאחר השיכון מבודד מאלמנטריות ולכן $tp(\bar{b} / A)$ מבודד.
\begin{theorem}[משפט מורלי בכיוון היורד]
	נניח ש־$T$ היא $\kappa$־קטגורית ל־$\aleph_1 \le \kappa$ ו־$|T| = \aleph_0$, אז $T$ היא $\aleph_1$־קטגורית.
\end{theorem}
\begin{lemma}
	נניח ש־$T$ היא טרנסצנדטלית־לחלוטין בת־מנייה ושלמה.
	אם $\Mm \models T$ מעוצמה לא בת־מנייה אז לכל $\kappa > |M|$ יש מודל $\Mm \prec \Nn$ כך שלכל טיפוס חלקי $\Sigma(x)$ בן־מנייה שמושמט ב־$\Mm$ יושמט גם ב־$\Nn$, ו־$|N| = \kappa$.
\end{lemma}
\begin{proof}
	נראה כי ניתן להרחיב את $\Mm$ בצעד בודד, כלומר למצוא $\Mm \prec \Mm'$ כך ש־$\Mm \ne \Mm'$ משמיט כל איפוס בן־מנייה חלקי שהושמט על־ידי $\Mm$.
	נחזור על הבנייה $\kappa$ פעמים כדי לבנות את $\Nn$.

	עבור הנוסחה $\varphi$ עם משתנה חופשי $x$ נאמר ש־$\varphi$ היא גדולה אם $|\varphi(M)| > \aleph_0$ כאשר $\varphi(M) = \{ a \in M \mid \varphi^\Mm(a) \}$.

	נוכיח את הלמה הבאה:
	יש $\varphi$ גדולה כך שלכל נוסחה $\psi(x)$ מתקיים $\varphi \land \psi$ קטנה או $\varphi \land (\lnot \psi)$ קטנה, ולא שני המקרים יחד.

	נוכיח את הלמה.
	יש נוסחה גדולה $(x = x)$ ואם הלמה לא נכונה, כלומר אפשר לפצל כל נוסחה גדולה לשתיים ולקבל עץ בינארי $\Gamma(x) = \{ \psi \mid \varphi \land \psi \text{ is big} \}$ טיפוס שלם.
	אכן, מההנחה אם $\varphi \land \psi$ לא גדולה אז $\varphi \land (\lnot \psi)$ גדולה ולכן $\psi_0, \ldots, \psi_{n - 1} \in \Gamma$ אז,
	\[
		(\varphi \land \psi_i) \lor (\bigvee_i \varphi \land (\lnot \psi_i)) \equiv \varphi
	\]
	מרחיב על־ידי לכל היותר מספר בן־מנייה של איברי $M$.
	יהי $a \in \Cc_T$ מממש את $\Gamma$.
	יהי $\Mm'$ מודל אטומי מעל $M_a$. נניח כעת ש־$b \in M'$ שמממש את $\Sigma(x)$, עבור טיפוס חלקי בן־מנייה.
	$\Mm'$ אטומי מעל $\Mm_a$ אז הטיפוס $tp(b / M_a)$ מבודד על־ידי $\psi(x, a)$. כלומר לכל $\rho \in \Sigma$ מתקיים,
	\[
		\Mm' \models \forall x\ (\psi(x, a) \to \rho(x))
	\]
	כלומר $a$ מספק $\xi(a) = \exists x\ \psi(x, a) \land \forall x\ (\psi(x, a) \to \rho(x))$.
	לכן הנוסחה $\varepsilon_{\rho} = \varphi(z) \land (\lnot \xi(z))$ היא קטנה.
	מתקיים $|\varepsilon_{\rho}(M)| \le \aleph_0$ ולכן $|\bigcup_{\rho \in \Sigma} \varepsilon_{\rho}(M)| \le \aleph_0$ ובהתאם יש $c \in \varphi(M)$ ו־$\lnot \varepsilon_{\rho}(c)$ לכל $\rho \in \Sigma$.
	נסיק ש־$\exists x\ \psi(x, c)$ וגם לכל $\rho \in \Sigma$ מתקיים $\forall x\ (\psi(x, c) \to \rho(x))$ מתקיים ב־$\Nn$.
	יהי $e \in M$ כך ש־$\Mm \models \psi(e, c)$ ונקבל ש־$\Mm \models \Sigma(e)$ כסתירה להנחה ש־$\Sigma$ הושמט ב־$\Mm$.

	נעבור לאיך הלמה שאם $T$ היא $\kappa$־קטגורית מעל שפה בת־מנייה ל־$\kappa \ge \aleph_1$ גוררת שהיא $\aleph_1$־קטגורית.
	אם נניח אחרת יש מודל $\Mm \models T$ בעוצמה $\aleph_1$ לא רווי, לכן יש טיפוס $\Sigma$ בן־מנייה מושמט.
	מ־$\kappa$־קטגוריות אנו יודעים ש־$T$ טרנסצנדטלית־לחלוטין, מהלמה יש $\Mm \prec \Nn$ בעוצמה $\kappa$ שמשמיט את $\Sigma$.
	מ־$\kappa$־קטגוריות $\Nn$ חייב להיות רווי בסתירה.
\end{proof}

מתוך $\aleph_1$־קטגוריות נוכל לקבל $\kappa$־קטגוריות ל־$\kappa > \aleph_1$.
בצעד הראשון, ל־$T$ אין זוגות ווטיאנים, כלומר מודלים $\Mm \prec \Nn$ שעבור נוסחה $\varphi$ כך ש־$\varphi(M) \ge \aleph_0$, $\varphi(M) = \varphi(N)$ אבל $\Mm \ne \Nn$.
בצעד השני, להראות שיש נוסחות מינימליות בחזק, כלומר שאם $\varphi$ נוסחה כך שלכל $\psi$ מתקיים ש־$(\varphi \land \psi)(M)$ סופית או $(\varphi \land (\lnot \psi))(M)$ סופית, כאשר $\varphi(M)$ אינסופית.
זה כמובן מתקיים לכל הרחבה אלמנטרית של $\Mm$.
אם $B_0, B_1$ בסיסים של $\varphi(M)$ ול־$\varphi(N)$ בהתאמה, ו־$f : B_0 \to B_1$ חד־חד ערכית ועל, אז ניתן להרחיב את $f$ לשיכון אלמנטרי חלקי מ־$\varphi(M)$ ל־$\varphi(N)$.
נניח ש־$\Nn_1, \Nn_2$ מודלים של $T$ בעוצמה $\kappa$ ו־$\varphi$ מינימלית בחזק.
נניח ש־$\Mm$ ראשוני בן־מנייה ו־$|\varphi(M)| = \aleph_0$, $\Mm \hookrightarrow \Nn_1$ ואם $\varphi(N_1)$ התמונות, אז $\varphi(M)$ זוג ווטיאני.
יתר־על־כן אם $\varphi(N_1)| < \kappa$ אז $Sk^{\Nn_1}(\varphi(N_1)) \prec \Nn_1$ עם אותו $\varphi$ ולכן זוג ווטיאני.
$\kappa = |\varphi(N_1)| = |\varphi(N_2)|$ כאשר $B_1 \subseteq N_1, B_2 \subseteq N_2$ הם מעוצמה $\kappa$.
בלי הגבלת הכלליות $\varphi(N_1) = \varphi(N_2) = A$ ונבנה מודל ראשוני מעל $A$ בתוך $\Nn_1$.
נטען ש־$\varphi(N_1) = \varphi(M_1)$ ולכן $M_1 = N_1$, וכן $\Nn_1 \hookrightarrow \Nn_2$ ולכן $\Nn_1 \cong \Nn_2$.
\begin{lemma}
	נניח ש־$\Mm \prec \Nn$, נעשיר את השפה $L$ על־ידי הוספת יחס חד־מקומי $P$ כך ש־$P(N) = M$.
	אז קיים $(\Mm, \Nn) \prec (\Mm', \Nn')$ כך שאם $p \in S_n(T)$ שמתממש ב־$\Nn'$ אז הוא מתממש ב־$\Mm'$, ו־$\Mm', \Nn'$ הומוגניים.
\end{lemma}
\begin{proof}
	מספיק להראות שעבור $(\Mm, \Nn)$ ו־$a \in N$ יש הרחבה אלמנטרית ל־$(\Mm', \Nn')$ בה יש $a' \in M'$ עם $tp(a') = tp(a)$, וזה מתקיים מקומפקטיות;
	לכל $\varphi \in tp(a)$ מתקיים $\Nn \models \varphi(a)$ אז,
	\[
		(\Mm, \Nn)
		\models \exists x\ (P(x) \land \varphi(x))
	\]

	נחזור על התהליך הזה $\omega$ צעדים.
\end{proof}

\section{שיעור 13 --- 18.1.2026}
\subsection{משפט מורלי}
\begin{theorem}[מורלי העולה]
	אם $T$ היא תורה $\aleph_1$־קטגורית אז $T$ היא $\kappa$־קטגורית לכל $\aleph_1 \le \kappa$.
\end{theorem}
\begin{definition}[זוג ווטיאני]
	זוג ווטיאני היא שלשה $(\Mm, \Nn, \varphi(x))$ עם $\Mm \prec \Nn, \Mm \ne \Nn$ כך ש־$\varphi(M) = \varphi(N)$ וגם $|\varphi(M)| \ge \aleph_0$.
\end{definition}
\begin{theorem}[ווט]
	נניח ש־$T$ תורה בשפה בת־מנייה שיש לה זוג ווטיאני.
	אז יש ל־$T$ מודל $\Nn \models T$ המקיים $\Mm \prec \Nn, |N| = \aleph_1, |M| = \aleph_0$ ו־$\varphi(N) = \varphi(M)$.
\end{theorem}
\begin{proof}
	ניזכר שאם $\Mm_0 \prec \Mm_1$ מודלים של $T$ אז יש $(\Mm_0, \Mm_1) \prec (\Mm_0', \Mm_1')$ כך שלכל $p \in S_n(T)$ מתקיים ש־$p$ מתממש ב־$\Mm_0'$ אם ורק א $p$ מתממש ב־$\Mm_1'$, כאשר כל המודלים הם בני־מנייה.
	בנוסף $\Mm_0', \Mm_1'$ הם הומוגניים, כלומר אם $tp(\bar{a}) = tp(\bar{b})$ אז ניתן להרחיב את ההעתקה $a_i \mapsto b_i$ לאיזומורפיזם.
	כל זה הוא מהלך שנובע מקומפקטיות.

	נניח כי $(\Mm_0, \Mm_1, \varphi)$ זוג ווטיאני כלשהו, אז נבחר תת־מודל אלמנטרי בן־מנייה של $(\Mm_0, \Mm_1)$ ונקבל זוג ווטיאני של מודלים בני־מנייה.
	בלי הגבלת הכלליות הם בני־מנייה מממשים את אותם טיפוסים, והומוגניים.
	בהתאם נובע ש־$\Mm_0 \cong \Mm_1$.
	נבנה באינדוקציה סדרת מודלים $(\Mm_{\alpha} \mid \alpha < \omega_1)$ כך שלכל $\alpha < \omega_1$ ולכל טיפוס $p \in S_n(T)$, $\Mm_{\alpha}$ מממש את $p$ אם ורק אם $\Mm_0$ מממש את $p$ והם הומוגניים,
	וכן $\varphi(M_0) = \varphi(M_{\alpha})$, ו־$\forall \beta < \alpha,\ \Mm_{\beta} \prec \Mm_{\alpha}$. \\
	נניח שנתון לנו $\Mm_0 \prec \Mm_{\alpha}$ כאשר $\alpha$ בן־מנייה.
	אז יש איזומורפיזם $f : \Mm_0 \to \Mm_{\alpha}$. המודל $\Cc_T$ הוא הומוגני ולכן ניתן להרחיב את $f$ ל־$\tilde{f} : \Cc_T \to \Cc_T$ אוטומורפיזם.
	נגדיר $\Mm_{\alpha + 1} = \tilde{f}(\Mm_{\alpha})$ ולכן $\Mm_{\alpha} = f(\Mm_0) = \tilde{f}(\Mm_0) \prec \tilde{f}(\Mm_{\alpha})$.
	נשים לב ש־$\Mm_{\alpha} \prec \Mm_{\alpha + 1}$.
	מכיוון ש־$\Mm_0 \prec \Mm_{\alpha} \prec \Mm_{\alpha + 1}$ אז $\Mm_0 \prec \Mm_{\alpha + 1}$ ו־$\varphi(M_0) = \varphi(M_{\alpha + 1})$.
	אם $y \in \varphi(M_{\alpha + 1})$ אז $y \in \tilde{f}(z)$ ו־$z \in \varphi(M_{\alpha})$ אבל אז $z \in M_0$ ולכן $y = \tilde{f}(z) = f(z) \in M_{\alpha}$, אז נובע ש־$y \in \varphi(M_{\alpha})$ ולכן גם $y \in \varphi(M_0)$.
	עבור $\alpha$ גבולי נגדיר $\Mm_{\alpha} = \bigcup_{\beta < \alpha} \Mm_{\beta}$, ושוב הוא מודל שמממש רק את הטיפוסים ש־$\Mm_0$ מימש, הומוגני ומתקיים,
	\[
		\varphi(M_{\alpha})
		= \bigcup_{\beta < \alpha} \varphi(M_{\beta})
		= \varphi(M_0)
	\]
	נגדיר $\Nn = \Mm_{\omega_1}$ ונקבל ש־$\varphi(N) = \bigcup_{\alpha < \omega_1} \varphi(M_{\alpha}) = \varphi(M_0)$ כרצוי.
\end{proof}
\begin{corollary}
	אם $T$ היא $\aleph_1$־קטגורית אז אין ל־$T$ זוג ווטיאני.
\end{corollary}
\begin{proof}
	$(\Mm, \Nn, \varphi)$ זוג ווטיאני ו־$|N| = \aleph_1$ אז $\Nn$ איננו רווי, נגדיר,
	\[
		p(x) = \{ \varphi(x) \} \cup \{ x \ne a \mid a \in \varphi(M) \}
	\]
	נוכל להניח ש־$|M| = \aleph_0, \Mm \prec \Nn$ ולכן זהו טיפוס חלקי שלא ניתן להרחבה לטיפוס שמתממש.
\end{proof}
\subsection{חילוץ כמת קיים אינסוף}
\begin{definition}[חילוץ כמת קיים אינסוף]
	תורה $T$ מחלצת $\exists^\infty$ אם לכל נוסחה $\varphi(x, \bar{y})$ יש נוסחה $\psi(\bar{y})$ כך שלכל מודל $\Mm \models T$ ו־$\bar{c} \in M^n$ מתקיים,
	\[
		|\{ a \in M \mid \Mm \models \varphi(a, \bar{c}) \}| \ge \aleph_0
		\iff \Mm \models \psi(\bar{c})
	\]
	ונסמן זאת ב־$\Mm \models \exists^\infty x\ \varphi(x, \bar{c})$.
\end{definition}
\begin{lemma}
	$T$ מחלצת $\exists^\infty$ אם ורק אם לכל נוסחה $\varphi(x, \bar{y})$ יש $n_\varphi$ כך שהאוסף $\{ a \in M \mid \Mm \models \varphi(a, \bar{c})\}$ אם ורק אם הוא גדול מ־$n_\varphi$.
\end{lemma}
\begin{proof}
	תרגיל בקומפקטיות.
\end{proof}
\begin{corollary}
	אם ל־$T$ אין זוגות ווטיאנים אז $T$ מחלצת את $\exists^\infty$.
\end{corollary}
\begin{proof}
	תהי $\varphi(x, \bar{y})$ נוסחה, ועלינו למצוא $n_\varphi$ מתאים.
	אז לכל $n$ טבעי יש מודל $\Mm_n \models T$ ופרמטר $\bar{c}_n \in M_n^k$ כך ש־$\{ a \mid \Mm_n \models \varphi(a, \bar{c}_n) \}$ סופי אך קטן מ־$n$.
	תהי הרחבה אלמנטרית ממש $\Mm_n \prec \Nn_n$ ונבחין כי $\varphi(M_n, \bar{c}_n) = \varphi(N_n, \bar{c}_n)$.
	עתה נעשיר את השפה ב־$P$ יחס חד־מקומי ונבנה זוג מודלים $(\Mm, \Nn)$ כאשר $\Mm \prec \Nn$ ויש קבוע $\bar{c}$ כך ש־$|\varphi(M, \bar{c})| \ge \aleph_0$ וכן $\varphi(M, \bar{c}) = \varphi(N, \bar{c})$.
\end{proof}
\begin{definition}[נוסחה מינימלית ביחס למבנה]
	נניח ש־$\Mm$ מבנה ו־$\varphi$ נוסחה, אז $\varphi$ מינימלית ביחס ל־$\Mm$ אם לכל נוסחה $\psi$ מתקיים $(\varphi \land \psi)(M)$ סופית או $(\varphi \land \lnot \psi)(M)$ סופית, אבל $\varphi(M)$ אינסופית.
\end{definition}
\begin{definition}[נוסחה אלגברית]
	נוסחה $\varphi(x)$ נקראת אלגברית אם $\varphi(M)$ סופית.
\end{definition}
\begin{remark}
	במבנה $\langle \NN, < \rangle$ הנוסחה $x = x$ היא מינימלית אבל זו לא תכונה של התורה, כלומר ההגדרה הזו לא ממש תופסת את מה שרצינו.
\end{remark}
\begin{definition}[נוסחה מינימלית בחזק]
	נוסחה $\varphi$ נקראת מינימלי בחזק אם לכל $\Nn$ כך ש־$\Mm \prec \Nn$, $\varphi$ מינימלית ב־$\Nn$.
\end{definition}
\begin{example}
	$x = x$ היא מינימלית בחזק ב־ACF\@.
\end{example}
\begin{example}
	ב־DLO אין נוסחה מינימלית.
\end{example}
\begin{proposition}
	נניח ש־$T$ היא טרנסצנדטלית־לחלוטין ללא מודלים סופיים, אז לכל $\psi$ נוסחה מעל $\Mm \models T$ שאיננה אלגברית,
	יש נוסחה $\varphi$ מינימלית בחזק כך ש־$\Mm \models \forall x\ (\varphi \to \psi)$ ו־$\varphi(M) \subseteq \psi(M)$.
\end{proposition}
\begin{proof}
	אחרת נגדיר באינדוקציה סדרת נוסחות $\varphi_{\langle \rangle} = \psi$,
	ובשלב $\eta \in 2^{< \omega}$ נניח ש־$\varphi_{\eta}$ מוגדרת ואיננה מינימלית בחזק ולכן יש $\rho$ כך ש־$\varphi_{\eta} \land \rho, \varphi_{\eta} \land \lnot \rho$ שתיהן לא אלגבריות ובפרט עקביות.
\end{proof}
\begin{remark}
	אם $T$ מחלצת $\exists^\infty$ אז לכל $\Mm \models T$ ולכל נוסחה $\varphi$, מתקיים $\varphi$ מינימלית אם ורק אם היא מינימלית בחזק.
\end{remark}
\begin{proof}
	נניח ש־$\varphi(x, c)$ מינימלית ב־$\Mm$.
	נניח כי קיים $\Mm \preceq \Nn$ בו $\varphi$ איננה מינימלית, אז יש $\psi(x, d)$ עבור $d \in N$ כך שמתקיים,
	\[
		\Nn \models \exists^\infty x\ (\varphi(x, c) \land \psi(x, d)) \land \exists^\infty x\ (\varphi(x, c) \land \lnot \psi(x, d))
	\]
	אז,
	\[
		\Nn \models \exists y\ (\exists^\infty\ \varphi(x, c) \land \psi(x, d)) \land \exists^\infty\ (\varphi(x, c) \land \lnot \psi(x, d))
	\]
	ולכן $\Mm$ מקיים זאת בסתירה.
\end{proof}
נניח ש־$\varphi$ מינימלי בחזק, ב־$U_\varphi$ ישנם הטיפוסים הבאים:
\begin{enumerate}
	\item טיפוסים אלגבריים, אלו הם טיפוסים שמכילים נוסה אלגברית $\psi$
	\item טיפוס יחיד לא אלגברי
\end{enumerate}
$p = \{ \psi \mid \varphi \land \psi \text{ is not algebraic} \}$, הטיפוס הלא אלגברי היחיד.
הטיפוס הזה למעשה מוגדר על מודל המפלצת $\Cc_T$ באותו אופן בדיוק, ואם $\sigma \in \aut(\Cc_T)$ שמקבע פרמטרים של $\varphi$, אז $\sigma_*(p) = p$.
זה נכון כי אם $\varphi \land \psi$ אלגבריים אז $\sigma_*(\varphi \land \psi)$ אלגברית.

נגדיר באינדוקציה סדרת איברים ב־$\Cc_T$ בהינתן $A$ על־ידי, $a_{\alpha}$ יממש את $p \restriction (A \cup \{ a_{\beta} \mid \beta < \alpha \})$.
לסדרה $(a_{\alpha} \mid \alpha < \kappa)$ נקרא סדרת מורלי והיא תהיה סדרת אי־בחינים מעל הפרמטרים $A$.
נדגים זאת לזוגות.
נניח ש־$\psi \in tp(a_{\alpha_0}, a_{\alpha_1} / A)$ ונסתכל על $a_{\beta_0}, a_{\beta_1}$ עבור $\beta_0 < \beta_1$,
\[
	\Cc_T \models p \restriction A(a_{\alpha_0}), p \restriction A(a_{\beta_0})
.\]
לכן $\sigma = \id_A \cup \{ (a_{\alpha_0}, a_{\beta_0}) \}$ שיכון אלמנטרי חלקי וניתן להרחבה לאוטומורפיזם של $\Cc_T$,
\[
	\sigma(p \restriction A \cup \{ a_{\alpha_0} \})
	= p \restriction A \cup \{ a_{\beta_0} \}
.\]
ולכן אם $\psi \in tp(a_{\alpha}, a_{\alpha} / A)$ אז $\psi \in tp(a_{\beta_0}, a_{\beta_1} / A)$.
\begin{proposition}
	נניח ש־$B$ קבוצה כלשהי ו־$\Cc \models (p \restriction B)(a)$ וכן $\Cc \models (p \restriction B \cup \{ a \})(b)$ אז,
	\[
		tp(a, b / B) = tp(b, a / B)
	.\]
\end{proposition}
\begin{proof}
	תהי סדרת מורלי $a, b, b_2, b_3, \ldots, b_{\omega}$ ונסתכל על נוסחה $\psi$ כך ש־$\psi(b_n, b_{\omega})$.
	מהאי־בחינות לכל $n$, $\psi(b_n, b_{\omega})$ ולכן הנוסחה $\psi(x, b_{\omega})$ לא אלגברית.
	נובע שהנוסחה $\psi(x, a) \in p \restriction B \cup \{ a \}$ (בלי הגבלת הכלליות $\psi \to \varphi$) ולכן $\psi(b, a)$.
	מאי־בחינות קיבלנו שאם $\psi(a, b)$ אז $\psi(b, a)$ עבור $\psi(x, y)$ שגוררת את $\varphi(x)$.
\end{proof}
\begin{proposition}
	יהיו $A, p, \varphi$ כמקודם.
	אם $_1, B_2$ קבוצות בלתי תלויות ב־$\varphi(\Cc)$ עם $|B_1| = |B_2|$ אז כל העתקה חד־חד־ערכית ועל $f : B_1 \to B_2$ ניתן להרחיב לשיכון אלמנטרי חלקי שמקבע את $A$, $f : \acl(B_1) \to \acl(B_2)$.
\end{proposition}
\begin{proof}
	נגדיר ש־$B$ בלתי תלויה על $A$ אם לכל $b \in B$ מתקיים $b \notin \acl(A \cup B \setminus \{ b \})$.
	נשים לב ש־קבוצה בלתי תלויה היא סדרת מורלי מעל $A$. לכן אם נמנה אותן כטיפוס סדר זהה $\kappa$ אז ההעתקה $b_i \mapsto b_i'$ כאשר $B_1 = \{ b_i \mid i < \kappa \}$ ו־$B_2 = \{ b_i' \mid i < \kappa \}$,
	שיכון אלמנטרי חלקי. לכן ניתן להרחיב לאוטומורפיזם של $\Cc$.
\end{proof}
\begin{proposition}
	נניח ש־$\Mm$ מודל של $T$ ו־$\varphi$ מינימלי בחזק,
	אז יש $B \subseteq \varphi(M)$ בלתי־תלויה ו־$\varphi(M) = \acl(B)$.
\end{proposition}
\begin{proof}
	תהי $B$ בלתי־תלויה ומקסימלית, אם $c \notin \acl(B)$ אז נטען שאין $b \in B$ כך ש־$b \in \acl((B \cup \{ c \}) \setminus\{ b \})$.
	אחרת נסמן $B' = B \setminus \{ b \}$, ונקבל ש־$b \notin  \acl(B')$ וכן $\Mm \models p \restriction B'(b)$, ו־$\Mm \models p \restriction B' \cup \{ b \}$.
	נובע ש־$tp(b, c / B') = tp(c, b / B')$ אבל $b \in \acl(B' \cup \{ c \})$ בסתירה.
\end{proof}
\begin{exercise}
	תהי $\varphi$ מינימלית בחזק, אז עוצמת הבסיס ל־$\varphi(M)$ מוגדרת היטב.
\end{exercise}
\begin{remark}
	אם $|\varphi(M)| > |T|$ אז זה טריוויאלי.
\end{remark}
\begin{proof}[הוכחת משפט מורלי]
	נניח ש־$T$ תורה $\aleph_1$־קטגורית, בפרט טרנסצנדטלית־לחלוטין וללא זוגות ווטיאנים.
	נניח ש־$\Mm$ מודל ראשוני ובן־מנייה.
	$\varphi$ מינימלית בחזק ב־$\Mm$.
	נניח ש־$\Nn_1, \Nn_2 \models T$ מעוצמה $\kappa$, בלי הגבלת הכלליות $\Mm \prec \Nn_1, \Nn_2$, לכן ניתן לבחון את $\varphi(N_1), \varphi(N_2)$.

	נוכיח את הטענה ש־$|\varphi(N_1)| = |\varphi(N_1)| = \kappa$.
	אחרת יש $\varphi(N_1) \subseteq \Nn' \prec \Nn_1$ ולכן $\varphi(N') = \varphi(N_1)$ אבל $|N'| < |N_1|$ ובפרט שונים ונקבל זוג ווטיאני.

	נניח ש־$B_1$ בסיס ל־$\varphi(N_1)$ בעוצמה $\kappa$ ו־$B_2$ בסיס ל־$\varphi(N_2)$ בעוצמה $\kappa$.
	אז $\kappa \le |\varphi(N_1)| \le {(|B_1|)}^{< \omega} \cdot \aleph_0 \cdot \aleph_0$ ומצד שני $|B_1| \le \kappa$ ולכן $|B_1| = \kappa$.
	לכן יש אוטומורפיזם של $\Cc$ שמעביר את $\varphi(N_1)$ ל־$\varphi(N_2)$, בלי הגבלת הכלליות נחליף את $\Nn_1$ בתמונתו ולכן $\varphi(N_1) = \varphi(N_2)$.
	נניח ש־$\Nn$ ניתן לבנייה מעל $\varphi(N_1) = \varphi(N_2)$ ולכן בפרט הוא ראשוני, אז $\Nn \prec \Cc_T$.
	נזכור כי מודל זה הוא אטומי מעל $A$ ובפרט אם $a \in N$ מקיים $\varphi(a)$ אז $a \in A$, לכן או שהוא אלגברי או שהוא $p \restriction A$.
	אם הוא אלגברי אז יש נוסחה $\psi$ אלגברית בטיפוס. כל המימושים של $\psi$ כבר שייכים ל־$\Nn_1, \Nn_2$ ולכן ל־ $A = \varphi(N_1) = \varphi(N_2)$.
	אם הוא $p \restriction A$ אז הוא לא מבודד.
	אם $\rho(x)$ מבודדת אותו אז $\rho \land \varphi$ לא אלגברית לכן אינסופית ונובע ש־$\rho \in p \restriction A$.
	$\rho$ מכיל מספר סופי של פרמטרים מ־$A$, נסמן $a_0, \ldots, a_{n - 1}$, ולכן כל איבר ב־$A$ מחוץ ל־$\acl(\bar{a})$ יקיים את $\rho$.
	ניקח $b$ כזה ונקבל ש־$\lnot (\rho \to x \ne b)$ בסתירה.
	לכן $\varphi(N) = A$ אבל $N$ ראשוני ולכן $\Nn \prec \Nn_1$.
	אם $\Nn \ne \Nn_1$ זהו זוג ווטיאני ולכן $\Nn \cong \Nn_1 \cong \Nn_2$ כנדרש.
\end{proof}
