...
\begin{example}[הילוכים מקריים]
	...
	\begin{align*}
		\PP(Y_n = 0)
		& = \PP(\sum_{i = 1}^n X_i = 0) \\
		& = \PP(\sum_{i = 1}^n Z_i = -n (p - \frac{1}{2})) \\
...
\begin{definition}[הילוך מקרי פשוט על גרף]
	באנגלית Simple Random Walk או SRW על גרף.
...
\begin{lemma}[הראשונה של בורל־קנטלי]
	אם ${\{ A_n \}}_{n = 1}^\infty$ כך ש־$\sum_{n \in \NN} \PP(A_n) < \infty$ אז $\PP(\lim_{n \to \infty} A_n) = 0$.
\end{lemma}
...
תנאי מספיק למדידות הפונקציה $X$ הוא שלכל $t \in \RR$ יתקיים $X^{-1}((-\infty, t)) \in \Ff$.
...
\begin{proof}
	...
	אם $k \in A_x$ אז $m + n + k \in A_y$ כי,
	\[
...
\end{definition}
\begin{definition}[הפילטרציה הטבעית]
	אם ${\{ X_n \}}_{n \in \NN}$ תהליך מקרי ונסמן,
	\[
		\Ff_n = \sigma(X_0, \ldots, X_n)
	\]
	נגדיר את $\{ \Ff_n \}$ להיות הפילטרציה הטבעית של $\{ X_n \}$.
\end{definition}
